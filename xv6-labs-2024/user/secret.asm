...
main(int argc, char *argv[])
{
  ...
  16:	89e50513          	addi	a0,a0,-1890 # 8b0 <malloc+0xfc>
  1a:	6e2000ef          	jal	6fc <printf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  3c:	89858593          	addi	a1,a1,-1896 # 8d0 <malloc+0x11c>
  40:	6525                	lui	a0,0x9
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3dc:	52880813          	addi	a6,a6,1320 # 900 <digits>
 3e0:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65e:	2a6b8b93          	addi	s7,s7,678 # 900 <digits>
 ...
 6a8:	25448493          	addi	s1,s1,596 # 8f8 <malloc+0x144>
        for(; *s; s++)
