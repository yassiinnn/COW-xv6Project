...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	20e58593          	addi	a1,a1,526 # 1220 <malloc+0xfe>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	1dc58593          	addi	a1,a1,476 # 1230 <malloc+0x10e>
      5c:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1b650513          	addi	a0,a0,438 # 1238 <malloc+0x116>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	28e70713          	addi	a4,a4,654 # 1338 <malloc+0x216>
    ...
    panic("runcmd");
      ...
      c6:	17e50513          	addi	a0,a0,382 # 1240 <malloc+0x11e>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	16c58593          	addi	a1,a1,364 # 1248 <malloc+0x126>
      e4:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     114:	14858593          	addi	a1,a1,328 # 1258 <malloc+0x136>
     118:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     176:	0f650513          	addi	a0,a0,246 # 1268 <malloc+0x146>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d4:	dc0b0b13          	addi	s6,s6,-576 # 1290 <malloc+0x16e>
  ...
  while(peek(ps, es, "<>")){
     ...
     4ea:	d8a50513          	addi	a0,a0,-630 # 1270 <malloc+0x14e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5aa:	cf260613          	addi	a2,a2,-782 # 1298 <malloc+0x176>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5de:	cdeb0b13          	addi	s6,s6,-802 # 12b8 <malloc+0x196>
  ...
  return ret;
     ...
     610:	c9450513          	addi	a0,a0,-876 # 12a0 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     65e:	c4e50513          	addi	a0,a0,-946 # 12a8 <malloc+0x186>
...
0000000000000684 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6a0:	c2460613          	addi	a2,a2,-988 # 12c0 <malloc+0x19e>
     6a4:	85ce                	mv	a1,s3
     6a6:	854a                	mv	a0,s2
...
00000000000006de <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6fc:	bd0a0a13          	addi	s4,s4,-1072 # 12c8 <malloc+0x1a6>
  ...
  if(peek(ps, es, ";")){
     ...
     726:	bae60613          	addi	a2,a2,-1106 # 12d0 <malloc+0x1ae>
     72a:	85ce                	mv	a1,s3
     72c:	854a                	mv	a0,s2
...
0000000000000766 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     77c:	b2060613          	addi	a2,a2,-1248 # 1298 <malloc+0x176>
  ...
  if(!peek(ps, es, ")"))
     ...
     7a0:	b4c60613          	addi	a2,a2,-1204 # 12e8 <malloc+0x1c6>
     7a4:	85ca                	mv	a1,s2
     7a6:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7d6:	b0650513          	addi	a0,a0,-1274 # 12d8 <malloc+0x1b6>
     7da:	871ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7de:	00001517          	auipc	a0,0x1
     7e2:	b1250513          	addi	a0,a0,-1262 # 12f0 <malloc+0x1ce>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     80a:	b4a70713          	addi	a4,a4,-1206 # 1350 <malloc+0x22e>
...
000000000000086a <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     89a:	99260613          	addi	a2,a2,-1646 # 1228 <malloc+0x106>
     89e:	85a6                	mv	a1,s1
     8a0:	854e                	mv	a0,s3
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8c8:	a4458593          	addi	a1,a1,-1468 # 1308 <malloc+0x1e6>
     8cc:	4509                	li	a0,2
     8ce:	772000ef          	jal	1040 <fprintf>
    panic("syntax");
     8d2:	00001517          	auipc	a0,0x1
     8d6:	9ce50513          	addi	a0,a0,-1586 # 12a0 <malloc+0x17e>
...
00000000000008de <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8f6:	a2690913          	addi	s2,s2,-1498 # 1318 <malloc+0x1f6>
     8fa:	85a6                	mv	a1,s1
     8fc:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     98c:	99858593          	addi	a1,a1,-1640 # 1320 <malloc+0x1fe>
     990:	4509                	li	a0,2
     992:	6ae000ef          	jal	1040 <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d2e:	63e80813          	addi	a6,a6,1598 # 1368 <digits>
     d32:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dae:	28048463          	beqz	s1,1036 <vprintf+0x296>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     df8:	22048763          	beqz	s1,1026 <vprintf+0x286>
    c0 = fmt[i] & 0xff;
    ...
    if(state == 0){
     ...
     e1a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e1e:	05878263          	beq	a5,s8,e62 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e22:	05978c63          	beq	a5,s9,e7a <vprintf+0xda>
     ...
     e2a:	0ee78663          	beq	a5,a4,f16 <vprintf+0x176>
     ...
     e32:	12e78863          	beq	a5,a4,f62 <vprintf+0x1c2>
     ...
     e3a:	14e78d63          	beq	a5,a4,f94 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     e3e:	07300713          	li	a4,115
     e42:	18e78c63          	beq	a5,a4,fda <vprintf+0x23a>
     ...
     e4a:	1ce78163          	beq	a5,a4,100c <vprintf+0x26c>
        putc(fd, va_arg(ap, int));
      } else if(c0 == '%'){
     e4e:	02500713          	li	a4,37
     e52:	04e79463          	bne	a5,a4,e9a <vprintf+0xfa>
        putc(fd, '%');
     e56:	85ba                	mv	a1,a4
     e58:	855a                	mv	a0,s6
     e5a:	e93ff0ef          	jal	cec <putc>
     ...
     e6e:	855a                	mv	a0,s6
     e70:	e9bff0ef          	jal	d0a <printint>
     e74:	8ba6                	mv	s7,s1
      state = 0;
     e76:	4981                	li	s3,0
     e78:	bf8d                	j	dea <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     e7a:	06400793          	li	a5,100
     e7e:	02f68963          	beq	a3,a5,eb0 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e82:	06c00793          	li	a5,108
     e86:	04f68263          	beq	a3,a5,eca <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     e8a:	07500793          	li	a5,117
     e8e:	0af68063          	beq	a3,a5,f2e <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     e92:	07800793          	li	a5,120
     e96:	0ef68263          	beq	a3,a5,f7a <vprintf+0x1da>
        putc(fd, '%');
     ...
     ea4:	85a6                	mv	a1,s1
     ea6:	855a                	mv	a0,s6
     ea8:	e45ff0ef          	jal	cec <putc>
      state = 0;
     eac:	4981                	li	s3,0
     eae:	bf35                	j	dea <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     ec6:	4981                	li	s3,0
        i += 1;
     ec8:	b70d                	j	dea <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eca:	06400793          	li	a5,100
     ece:	02f60763          	beq	a2,a5,efc <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     ed2:	07500793          	li	a5,117
     ed6:	06f60963          	beq	a2,a5,f48 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     eda:	07800793          	li	a5,120
     ede:	faf61ee3          	bne	a2,a5,e9a <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f22:	855a                	mv	a0,s6
     f24:	de7ff0ef          	jal	d0a <printint>
     f28:	8ba6                	mv	s7,s1
      state = 0;
     f2a:	4981                	li	s3,0
     f2c:	bd7d                	j	dea <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f6e:	855a                	mv	a0,s6
     f70:	d9bff0ef          	jal	d0a <printint>
     f74:	8ba6                	mv	s7,s1
      state = 0;
     f76:	4981                	li	s3,0
     f78:	bd8d                	j	dea <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     ff6:	f9f5                	bnez	a1,fea <vprintf+0x24a>
        if((s = va_arg(ap, char*)) == 0)
     ff8:	8bce                	mv	s7,s3
      state = 0;
     ffa:	4981                	li	s3,0
     ffc:	b3fd                	j	dea <vprintf+0x4a>
          s = "(null)";
     ffe:	00000497          	auipc	s1,0x0
    1002:	33248493          	addi	s1,s1,818 # 1330 <malloc+0x20e>
        for(; *s; s++)
    1006:	02800593          	li	a1,40
    100a:	b7c5                	j	fea <vprintf+0x24a>
        putc(fd, va_arg(ap, int));
    100c:	008b8493          	addi	s1,s7,8
    1010:	000bc583          	lbu	a1,0(s7)
    1014:	855a                	mv	a0,s6
    1016:	cd7ff0ef          	jal	cec <putc>
    101a:	8ba6                	mv	s7,s1
      state = 0;
    101c:	4981                	li	s3,0
    101e:	b3f1                	j	dea <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1020:	8bce                	mv	s7,s3
      state = 0;
    1022:	4981                	li	s3,0
    1024:	b3d9                	j	dea <vprintf+0x4a>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  va_start(ap, fmt);
    1058:	8622                	mv	a2,s0
    105a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    105e:	d43ff0ef          	jal	da0 <vprintf>
  va_end(ap);
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    10a4:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10a8:	00001797          	auipc	a5,0x1
    10ac:	f687b783          	ld	a5,-152(a5) # 2010 <freep>
    10b0:	a02d                	j	10da <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    10b2:	4618                	lw	a4,8(a2)
    10b4:	9f2d                	addw	a4,a4,a1
    10b6:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    10ba:	6398                	ld	a4,0(a5)
    10bc:	6310                	ld	a2,0(a4)
    10be:	a83d                	j	10fc <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    10c0:	ff852703          	lw	a4,-8(a0)
    10c4:	9f31                	addw	a4,a4,a2
    10c6:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    10c8:	ff053683          	ld	a3,-16(a0)
    10cc:	a091                	j	1110 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10ce:	6398                	ld	a4,0(a5)
    10d0:	00e7e463          	bltu	a5,a4,10d8 <free+0x3c>
    10d4:	00e6ea63          	bltu	a3,a4,10e8 <free+0x4c>
{
    10d8:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10da:	fed7fae3          	bgeu	a5,a3,10ce <free+0x32>
    10de:	6398                	ld	a4,0(a5)
    10e0:	00e6e463          	bltu	a3,a4,10e8 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10e4:	fee7eae3          	bltu	a5,a4,10d8 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    10e8:	ff852583          	lw	a1,-8(a0)
    10ec:	6390                	ld	a2,0(a5)
    10ee:	02059813          	slli	a6,a1,0x20
    10f2:	01c85713          	srli	a4,a6,0x1c
    10f6:	9736                	add	a4,a4,a3
    10f8:	fae60de3          	beq	a2,a4,10b2 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
    10fc:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1100:	4790                	lw	a2,8(a5)
    1102:	02061593          	slli	a1,a2,0x20
    1106:	01c5d713          	srli	a4,a1,0x1c
    110a:	973e                	add	a4,a4,a5
    110c:	fae68ae3          	beq	a3,a4,10c0 <free+0x24>
    p->s.ptr = bp->s.ptr;
    1110:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    1112:	00001717          	auipc	a4,0x1
    1116:	eef73f23          	sd	a5,-258(a4) # 2010 <freep>
}
    111a:	60a2                	ld	ra,8(sp)
    111c:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    112e:	02051993          	slli	s3,a0,0x20
    1132:	0209d993          	srli	s3,s3,0x20
    1136:	09bd                	addi	s3,s3,15
    1138:	0049d993          	srli	s3,s3,0x4
    113c:	2985                	addiw	s3,s3,1
    113e:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    1140:	00001517          	auipc	a0,0x1
    1144:	ed053503          	ld	a0,-304(a0) # 2010 <freep>
    1148:	c905                	beqz	a0,1178 <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    114a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    114c:	4798                	lw	a4,8(a5)
    114e:	09377663          	bgeu	a4,s3,11da <malloc+0xb8>
  ...
  if(nu < 4096)
    115a:	8a4e                	mv	s4,s3
    115c:	6705                	lui	a4,0x1
    115e:	00e9f363          	bgeu	s3,a4,1164 <malloc+0x42>
    1162:	6a05                	lui	s4,0x1
    1164:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1168:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    116c:	00001497          	auipc	s1,0x1
    1170:	ea448493          	addi	s1,s1,-348 # 2010 <freep>
  if(p == (char*)-1)
    1174:	5afd                	li	s5,-1
    1176:	a83d                	j	11b4 <malloc+0x92>
    ...
    1184:	f0878793          	addi	a5,a5,-248 # 2088 <base>
    1188:	00001717          	auipc	a4,0x1
    118c:	e8f73423          	sd	a5,-376(a4) # 2010 <freep>
    1190:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    1192:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1196:	b7d1                	j	115a <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    1198:	6398                	ld	a4,0(a5)
    119a:	e118                	sd	a4,0(a0)
    119c:	a899                	j	11f2 <malloc+0xd0>
  hp->s.size = nu;
    119e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11a2:	0541                	addi	a0,a0,16
    11a4:	ef9ff0ef          	jal	109c <free>
  return freep;
    11a8:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    11aa:	c125                	beqz	a0,120a <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11ac:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11ae:	4798                	lw	a4,8(a5)
    11b0:	03277163          	bgeu	a4,s2,11d2 <malloc+0xb0>
    if(p == freep)
    11b4:	6098                	ld	a4,0(s1)
    11b6:	853e                	mv	a0,a5
    11b8:	fef71ae3          	bne	a4,a5,11ac <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    11bc:	8552                	mv	a0,s4
    11be:	b17ff0ef          	jal	cd4 <sbrk>
  if(p == (char*)-1)
    11c2:	fd551ee3          	bne	a0,s5,119e <malloc+0x7c>
        return 0;
    11c6:	4501                	li	a0,0
    ...
    11d0:	a03d                	j	11fe <malloc+0xdc>
    11d2:	74a2                	ld	s1,40(sp)
    11d4:	6a42                	ld	s4,16(sp)
    11d6:	6aa2                	ld	s5,8(sp)
    11d8:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    11da:	fae90fe3          	beq	s2,a4,1198 <malloc+0x76>
        p->s.size -= nunits;
    11de:	4137073b          	subw	a4,a4,s3
    11e2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    11e4:	02071693          	slli	a3,a4,0x20
    11e8:	01c6d713          	srli	a4,a3,0x1c
    11ec:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    11ee:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    11f2:	00001717          	auipc	a4,0x1
    11f6:	e0a73f23          	sd	a0,-482(a4) # 2010 <freep>
      return (void*)(p + 1);
    11fa:	01078513          	addi	a0,a5,16
  }
}
