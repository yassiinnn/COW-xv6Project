...
free(void *ap)
{
 ...
 96a:	69a7b783          	ld	a5,1690(a5) # 2000 <freep>
...
malloc(uint nbytes)
{
 ...
 a2e:	5d648493          	addi	s1,s1,1494 # 2000 <freep>
  if(p == (char*)-1)
 a32:	5afd                	li	s5,-1
 ...
 a42:	5e278793          	addi	a5,a5,1506 # 2020 <base>
 a46:	00001717          	auipc	a4,0x1
 a4a:	5af73d23          	sd	a5,1466(a4) # 2000 <freep>
 a4e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
