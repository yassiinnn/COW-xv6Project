...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5142:	00004797          	auipc	a5,0x4
    5146:	30e7b783          	ld	a5,782(a5) # 9450 <freep>
    ...
    516e:	00e6ea63          	bltu	a3,a4,5182 <free+0x4c>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    51ac:	00004717          	auipc	a4,0x4
    51b0:	2af73223          	sd	a5,676(a4) # 9450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    51de:	27653503          	ld	a0,630(a0) # 9450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    5206:	00004497          	auipc	s1,0x4
    520a:	24a48493          	addi	s1,s1,586 # 9450 <freep>
  if(p == (char*)-1)
    520e:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    521a:	0000b797          	auipc	a5,0xb
    521e:	a5e78793          	addi	a5,a5,-1442 # fc78 <base>
    5222:	00004717          	auipc	a4,0x4
    5226:	22f73723          	sd	a5,558(a4) # 9450 <freep>
  ...
  if(p == (char*)-1)
    ...
    5288:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    528c:	00004717          	auipc	a4,0x4
    5290:	1ca73223          	sd	a0,452(a4) # 9450 <freep>
      return (void*)(p + 1);
