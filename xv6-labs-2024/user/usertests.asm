...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	65878793          	addi	a5,a5,1624 # 7668 <malloc+0x2490>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	26450513          	addi	a0,a0,612 # 52d0 <malloc+0xf8>
      74:	0ac050ef          	jal	5120 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	24a50513          	addi	a0,a0,586 # 52f0 <malloc+0x118>
      ae:	072050ef          	jal	5120 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	24250513          	addi	a0,a0,578 # 5308 <malloc+0x130>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	24c50513          	addi	a0,a0,588 # 5328 <malloc+0x150>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	21850513          	addi	a0,a0,536 # 5310 <malloc+0x138>
     100:	020050ef          	jal	5120 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	22c50513          	addi	a0,a0,556 # 5338 <malloc+0x160>
     114:	00c050ef          	jal	5120 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	1de50513          	addi	a0,a0,478 # 5360 <malloc+0x188>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	1d450513          	addi	a0,a0,468 # 5380 <malloc+0x1a8>
     1b4:	76d040ef          	jal	5120 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     25e:	14e50513          	addi	a0,a0,334 # 53a8 <malloc+0x1d0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     272:	13aa8a93          	addi	s5,s5,314 # 53a8 <malloc+0x1d0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	0dc50513          	addi	a0,a0,220 # 53b8 <malloc+0x1e0>
     2e4:	63d040ef          	jal	5120 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2fa:	0e250513          	addi	a0,a0,226 # 53d8 <malloc+0x200>
     2fe:	623040ef          	jal	5120 <printf>
        exit(1);
     302:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     320:	0d450513          	addi	a0,a0,212 # 53f0 <malloc+0x218>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     334:	0c098993          	addi	s3,s3,192 # 53f0 <malloc+0x218>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     370:	08450513          	addi	a0,a0,132 # 53f0 <malloc+0x218>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     384:	ff858593          	addi	a1,a1,-8 # 5378 <malloc+0x1a0>
     388:	19b040ef          	jal	4d22 <write>
     38c:	4785                	li	a5,1
     38e:	02f50d63          	beq	a0,a5,3c8 <badwrite+0xc0>
    printf("write failed\n");
     392:	00005517          	auipc	a0,0x5
     396:	07e50513          	addi	a0,a0,126 # 5410 <malloc+0x238>
     39a:	587040ef          	jal	5120 <printf>
    exit(1);
     39e:	4505                	li	a0,1
     3a0:	163040ef          	jal	4d02 <exit>
      printf("open junk failed\n");
     3a4:	00005517          	auipc	a0,0x5
     3a8:	05450513          	addi	a0,a0,84 # 53f8 <malloc+0x220>
     3ac:	575040ef          	jal	5120 <printf>
      exit(1);
     3b0:	4505                	li	a0,1
     3b2:	151040ef          	jal	4d02 <exit>
    printf("open junk failed\n");
     3b6:	00005517          	auipc	a0,0x5
     3ba:	04250513          	addi	a0,a0,66 # 53f8 <malloc+0x220>
     3be:	563040ef          	jal	5120 <printf>
    exit(1);
     3c2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d2:	02250513          	addi	a0,a0,34 # 53f0 <malloc+0x218>
...
00000000000004ac <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4ca:	1a278793          	addi	a5,a5,418 # 7668 <malloc+0x2490>
     4ce:	638c                	ld	a1,0(a5)
     4d0:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fc:	f28a8a93          	addi	s5,s5,-216 # 5420 <malloc+0x248>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58e:	e9e50513          	addi	a0,a0,-354 # 5428 <malloc+0x250>
     592:	38f040ef          	jal	5120 <printf>
      exit(1);
     596:	4505                	li	a0,1
     ...
     5a4:	ea050513          	addi	a0,a0,-352 # 5440 <malloc+0x268>
     5a8:	379040ef          	jal	5120 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	eba50513          	addi	a0,a0,-326 # 5470 <malloc+0x298>
     5be:	363040ef          	jal	5120 <printf>
      exit(1);
     5c2:	4505                	li	a0,1
     5c4:	73e040ef          	jal	4d02 <exit>
      printf("pipe() failed\n");
     5c8:	00005517          	auipc	a0,0x5
     5cc:	ed850513          	addi	a0,a0,-296 # 54a0 <malloc+0x2c8>
     5d0:	351040ef          	jal	5120 <printf>
      exit(1);
     5d4:	4505                	li	a0,1
     ...
     5e2:	ed250513          	addi	a0,a0,-302 # 54b0 <malloc+0x2d8>
     5e6:	33b040ef          	jal	5120 <printf>
      exit(1);
     5ea:	4505                	li	a0,1
...
00000000000005f0 <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60e:	05e78793          	addi	a5,a5,94 # 7668 <malloc+0x2490>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     642:	ea2b0b13          	addi	s6,s6,-350 # 54e0 <malloc+0x308>
    ...
    n = write(fds[1], "x", 1);
     ...
     652:	d2ab8b93          	addi	s7,s7,-726 # 5378 <malloc+0x1a0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d8:	e1450513          	addi	a0,a0,-492 # 54e8 <malloc+0x310>
     6dc:	245040ef          	jal	5120 <printf>
      exit(1);
     6e0:	4505                	li	a0,1
     ...
     6ee:	e1650513          	addi	a0,a0,-490 # 5500 <malloc+0x328>
     6f2:	22f040ef          	jal	5120 <printf>
      exit(1);
     6f6:	4505                	li	a0,1
     6f8:	60a040ef          	jal	4d02 <exit>
      printf("pipe() failed\n");
     6fc:	00005517          	auipc	a0,0x5
     700:	da450513          	addi	a0,a0,-604 # 54a0 <malloc+0x2c8>
     704:	21d040ef          	jal	5120 <printf>
      exit(1);
     708:	4505                	li	a0,1
     70a:	5f8040ef          	jal	4d02 <exit>
      printf("pipe write failed\n");
     70e:	00005517          	auipc	a0,0x5
     712:	e2250513          	addi	a0,a0,-478 # 5530 <malloc+0x358>
     716:	20b040ef          	jal	5120 <printf>
      exit(1);
     71a:	4505                	li	a0,1
     ...
     728:	e2450513          	addi	a0,a0,-476 # 5548 <malloc+0x370>
     72c:	1f5040ef          	jal	5120 <printf>
      exit(1);
     730:	4505                	li	a0,1
...
0000000000000736 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     74e:	c1650513          	addi	a0,a0,-1002 # 5360 <malloc+0x188>
     752:	600040ef          	jal	4d52 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     756:	60100593          	li	a1,1537
     75a:	00005517          	auipc	a0,0x5
     75e:	c0650513          	addi	a0,a0,-1018 # 5360 <malloc+0x188>
     762:	5e0040ef          	jal	4d42 <open>
     766:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     768:	4611                	li	a2,4
     76a:	00005597          	auipc	a1,0x5
     76e:	c0658593          	addi	a1,a1,-1018 # 5370 <malloc+0x198>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     782:	be250513          	addi	a0,a0,-1054 # 5360 <malloc+0x188>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a6:	bbe50513          	addi	a0,a0,-1090 # 5360 <malloc+0x188>
     7aa:	598040ef          	jal	4d42 <open>
     7ae:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7b0:	4581                	li	a1,0
     7b2:	00005517          	auipc	a0,0x5
     7b6:	bae50513          	addi	a0,a0,-1106 # 5360 <malloc+0x188>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e8:	df458593          	addi	a1,a1,-524 # 55d8 <malloc+0x400>
     7ec:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81e:	b4650513          	addi	a0,a0,-1210 # 5360 <malloc+0x188>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     852:	d2a50513          	addi	a0,a0,-726 # 5578 <malloc+0x3a0>
     856:	0cb040ef          	jal	5120 <printf>
    exit(1);
     85a:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     866:	d3650513          	addi	a0,a0,-714 # 5598 <malloc+0x3c0>
     86a:	0b7040ef          	jal	5120 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86e:	8652                	mv	a2,s4
     870:	85d6                	mv	a1,s5
     872:	00005517          	auipc	a0,0x5
     876:	d3650513          	addi	a0,a0,-714 # 55a8 <malloc+0x3d0>
     87a:	0a7040ef          	jal	5120 <printf>
    exit(1);
     87e:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     88a:	d4250513          	addi	a0,a0,-702 # 55c8 <malloc+0x3f0>
     88e:	093040ef          	jal	5120 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     892:	8652                	mv	a2,s4
     894:	85d6                	mv	a1,s5
     896:	00005517          	auipc	a0,0x5
     89a:	d1250513          	addi	a0,a0,-750 # 55a8 <malloc+0x3d0>
     89e:	083040ef          	jal	5120 <printf>
    exit(1);
     8a2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8b0:	d3450513          	addi	a0,a0,-716 # 55e0 <malloc+0x408>
     8b4:	06d040ef          	jal	5120 <printf>
    exit(1);
     8b8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c6:	d3e50513          	addi	a0,a0,-706 # 5600 <malloc+0x428>
     8ca:	057040ef          	jal	5120 <printf>
    exit(1);
     8ce:	4505                	li	a0,1
...
00000000000008d4 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f4:	d3050513          	addi	a0,a0,-720 # 5620 <malloc+0x448>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     90a:	d42a0a13          	addi	s4,s4,-702 # 5648 <malloc+0x470>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90e:	00005b17          	auipc	s6,0x5
     912:	d72b0b13          	addi	s6,s6,-654 # 5680 <malloc+0x4a8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     948:	cdc50513          	addi	a0,a0,-804 # 5620 <malloc+0x448>
  ...
  if(unlink("small") < 0){
     ...
     978:	cac50513          	addi	a0,a0,-852 # 5620 <malloc+0x448>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     9a0:	c8c50513          	addi	a0,a0,-884 # 5628 <malloc+0x450>
     9a4:	77c040ef          	jal	5120 <printf>
    exit(1);
     9a8:	4505                	li	a0,1
     ...
     9b6:	ca650513          	addi	a0,a0,-858 # 5658 <malloc+0x480>
     9ba:	766040ef          	jal	5120 <printf>
      exit(1);
     9be:	4505                	li	a0,1
     ...
     9cc:	cc850513          	addi	a0,a0,-824 # 5690 <malloc+0x4b8>
     9d0:	750040ef          	jal	5120 <printf>
      exit(1);
     9d4:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9e0:	cdc50513          	addi	a0,a0,-804 # 56b8 <malloc+0x4e0>
     9e4:	73c040ef          	jal	5120 <printf>
    exit(1);
     9e8:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f4:	ce850513          	addi	a0,a0,-792 # 56d8 <malloc+0x500>
     9f8:	728040ef          	jal	5120 <printf>
    exit(1);
     9fc:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a08:	cec50513          	addi	a0,a0,-788 # 56f0 <malloc+0x518>
     a0c:	714040ef          	jal	5120 <printf>
    exit(1);
     a10:	4505                	li	a0,1
...
0000000000000a16 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a34:	ce050513          	addi	a0,a0,-800 # 5710 <malloc+0x538>
  ...
  fd = open("big", O_RDONLY);
     ...
     a78:	c9c50513          	addi	a0,a0,-868 # 5710 <malloc+0x538>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab6:	c6650513          	addi	a0,a0,-922 # 5718 <malloc+0x540>
     aba:	666040ef          	jal	5120 <printf>
    exit(1);
     abe:	4505                	li	a0,1
     ...
     acc:	c7050513          	addi	a0,a0,-912 # 5738 <malloc+0x560>
     ad0:	650040ef          	jal	5120 <printf>
      exit(1);
     ad4:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ae0:	c8450513          	addi	a0,a0,-892 # 5760 <malloc+0x588>
     ae4:	63c040ef          	jal	5120 <printf>
    exit(1);
     ae8:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     b00:	c1450513          	addi	a0,a0,-1004 # 5710 <malloc+0x538>
     ...
     b28:	c5c50513          	addi	a0,a0,-932 # 5780 <malloc+0x5a8>
     b2c:	5f4040ef          	jal	5120 <printf>
        exit(1);
     b30:	4505                	li	a0,1
     ...
     b3e:	c6e50513          	addi	a0,a0,-914 # 57a8 <malloc+0x5d0>
     b42:	5de040ef          	jal	5120 <printf>
      exit(1);
     b46:	4505                	li	a0,1
     ...
     b54:	c7050513          	addi	a0,a0,-912 # 57c0 <malloc+0x5e8>
     b58:	5c8040ef          	jal	5120 <printf>
      exit(1);
     b5c:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b68:	c8450513          	addi	a0,a0,-892 # 57e8 <malloc+0x610>
     b6c:	5b4040ef          	jal	5120 <printf>
    exit(1);
     b70:	4505                	li	a0,1
...
0000000000000b76 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8e:	c7650513          	addi	a0,a0,-906 # 5800 <malloc+0x628>
  ...
  write(fd, "hello", SZ);
     ...
     ba2:	c9258593          	addi	a1,a1,-878 # 5830 <malloc+0x658>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb6:	c4e50513          	addi	a0,a0,-946 # 5800 <malloc+0x628>
  ...
  unlink("unlinkread");
     ...
     c3e:	bc650513          	addi	a0,a0,-1082 # 5800 <malloc+0x628>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c5a:	bba50513          	addi	a0,a0,-1094 # 5810 <malloc+0x638>
     c5e:	4c2040ef          	jal	5120 <printf>
    exit(1);
     c62:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6e:	bce50513          	addi	a0,a0,-1074 # 5838 <malloc+0x660>
     c72:	4ae040ef          	jal	5120 <printf>
    exit(1);
     c76:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c82:	bda50513          	addi	a0,a0,-1062 # 5858 <malloc+0x680>
     c86:	49a040ef          	jal	5120 <printf>
    exit(1);
     c8a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c96:	bee50513          	addi	a0,a0,-1042 # 5880 <malloc+0x6a8>
     c9a:	486040ef          	jal	5120 <printf>
    exit(1);
     c9e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     caa:	bfa50513          	addi	a0,a0,-1030 # 58a0 <malloc+0x6c8>
     cae:	472040ef          	jal	5120 <printf>
    exit(1);
     cb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbe:	c0650513          	addi	a0,a0,-1018 # 58c0 <malloc+0x6e8>
     cc2:	45e040ef          	jal	5120 <printf>
    exit(1);
     cc6:	4505                	li	a0,1
...
0000000000000ccc <linktest>:
{
  ...
  unlink("lf1");
     ...
     cde:	c0650513          	addi	a0,a0,-1018 # 58e0 <malloc+0x708>
     ce2:	070040ef          	jal	4d52 <unlink>
  unlink("lf2");
     ce6:	00005517          	auipc	a0,0x5
     cea:	c0250513          	addi	a0,a0,-1022 # 58e8 <malloc+0x710>
     cee:	064040ef          	jal	4d52 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf2:	20200593          	li	a1,514
     cf6:	00005517          	auipc	a0,0x5
     cfa:	bea50513          	addi	a0,a0,-1046 # 58e0 <malloc+0x708>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0e:	b2658593          	addi	a1,a1,-1242 # 5830 <malloc+0x658>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de6:	b0e50513          	addi	a0,a0,-1266 # 58f0 <malloc+0x718>
     dea:	336040ef          	jal	5120 <printf>
    exit(1);
     dee:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     dfa:	b1250513          	addi	a0,a0,-1262 # 5908 <malloc+0x730>
     dfe:	322040ef          	jal	5120 <printf>
    exit(1);
     e02:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0e:	b1650513          	addi	a0,a0,-1258 # 5920 <malloc+0x748>
     e12:	30e040ef          	jal	5120 <printf>
    exit(1);
     e16:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e22:	b2250513          	addi	a0,a0,-1246 # 5940 <malloc+0x768>
     e26:	2fa040ef          	jal	5120 <printf>
    exit(1);
     e2a:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e36:	b3e50513          	addi	a0,a0,-1218 # 5970 <malloc+0x798>
     e3a:	2e6040ef          	jal	5120 <printf>
    exit(1);
     e3e:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e4a:	b4250513          	addi	a0,a0,-1214 # 5988 <malloc+0x7b0>
     e4e:	2d2040ef          	jal	5120 <printf>
    exit(1);
     e52:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5e:	b4650513          	addi	a0,a0,-1210 # 59a0 <malloc+0x7c8>
     e62:	2be040ef          	jal	5120 <printf>
    exit(1);
     e66:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e72:	b5a50513          	addi	a0,a0,-1190 # 59c8 <malloc+0x7f0>
     e76:	2aa040ef          	jal	5120 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e86:	b7650513          	addi	a0,a0,-1162 # 59f8 <malloc+0x820>
     e8a:	296040ef          	jal	5120 <printf>
    exit(1);
     e8e:	4505                	li	a0,1
...
0000000000000e94 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eb0:	b6c98993          	addi	s3,s3,-1172 # 5a18 <malloc+0x840>
     eb4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb6:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee8:	b4450513          	addi	a0,a0,-1212 # 5a28 <malloc+0x850>
     eec:	234040ef          	jal	5120 <printf>
      exit(1);
     ef0:	4505                	li	a0,1
...
0000000000000ef6 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f12:	b3a50513          	addi	a0,a0,-1222 # 5a48 <malloc+0x870>
     f16:	63d030ef          	jal	4d52 <unlink>
  fd = open("bd", O_CREATE);
     f1a:	20000593          	li	a1,512
     f1e:	00005517          	auipc	a0,0x5
     f22:	b2a50513          	addi	a0,a0,-1238 # 5a48 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f40:	b0ca0a13          	addi	s4,s4,-1268 # 5a48 <malloc+0x870>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8c:	ac050513          	addi	a0,a0,-1344 # 5a48 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff8:	a5c50513          	addi	a0,a0,-1444 # 5a50 <malloc+0x878>
     ffc:	124040ef          	jal	5120 <printf>
    exit(1);
    1000:	4505                	li	a0,1
    ...
    1012:	a6250513          	addi	a0,a0,-1438 # 5a70 <malloc+0x898>
    1016:	10a040ef          	jal	5120 <printf>
      exit(1);
    101a:	4505                	li	a0,1
    ...
    1026:	a7650513          	addi	a0,a0,-1418 # 5a98 <malloc+0x8c0>
    102a:	0f6040ef          	jal	5120 <printf>
      exit(1);
    102e:	4505                	li	a0,1
...
0000000000001060 <badarg>:
{
    ...
    1084:	28898993          	addi	s3,s3,648 # 5308 <malloc+0x130>
    argv[0] = (char*)0xffffffff;
...
00000000000010a2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f8:	af478793          	addi	a5,a5,-1292 # 6be8 <malloc+0x1a10>
  ...
  if(pid == 0){
    ...
    114c:	52078793          	addi	a5,a5,1312 # 7668 <malloc+0x2490>
    ...
    1170:	19c50513          	addi	a0,a0,412 # 5308 <malloc+0x130>
    ...
    1184:	9c050513          	addi	a0,a0,-1600 # 5b40 <malloc+0x968>
    1188:	799030ef          	jal	5120 <printf>
      exit(1);
    118c:	4505                	li	a0,1
    ...
    119c:	92050513          	addi	a0,a0,-1760 # 5ab8 <malloc+0x8e0>
    11a0:	781030ef          	jal	5120 <printf>
    exit(1);
    11a4:	4505                	li	a0,1
    ...
    11b4:	92850513          	addi	a0,a0,-1752 # 5ad8 <malloc+0x900>
    11b8:	769030ef          	jal	5120 <printf>
    exit(1);
    11bc:	4505                	li	a0,1
    ...
    11ce:	92e50513          	addi	a0,a0,-1746 # 5af8 <malloc+0x920>
    11d2:	74f030ef          	jal	5120 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
    ...
    11e6:	93e50513          	addi	a0,a0,-1730 # 5b20 <malloc+0x948>
    11ea:	737030ef          	jal	5120 <printf>
    exit(1);
    11ee:	4505                	li	a0,1
    11f0:	313030ef          	jal	4d02 <exit>
    printf("fork failed\n");
    11f4:	00006517          	auipc	a0,0x6
    11f8:	f1450513          	addi	a0,a0,-236 # 7108 <malloc+0x1f30>
    11fc:	725030ef          	jal	5120 <printf>
    exit(1);
    1200:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1232:	93a50513          	addi	a0,a0,-1734 # 5b68 <malloc+0x990>
    1236:	6eb030ef          	jal	5120 <printf>
    exit(1);
    123a:	4505                	li	a0,1
...
0000000000001240 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1254:	11050513          	addi	a0,a0,272 # 5360 <malloc+0x188>
  ...
  if(pid == 0){
    ...
    1284:	0e098993          	addi	s3,s3,224 # 5360 <malloc+0x188>
      int n = write(fd, "1234567890", 10);
    1288:	4a29                	li	s4,10
    128a:	00005b97          	auipc	s7,0x5
    128e:	93eb8b93          	addi	s7,s7,-1730 # 5bc8 <malloc+0x9f0>
    ...
    12f4:	8a850513          	addi	a0,a0,-1880 # 5b98 <malloc+0x9c0>
    12f8:	629030ef          	jal	5120 <printf>
    exit(1);
    12fc:	4505                	li	a0,1
    ...
    1308:	8ac50513          	addi	a0,a0,-1876 # 5bb0 <malloc+0x9d8>
    130c:	615030ef          	jal	5120 <printf>
        exit(1);
    1310:	4505                	li	a0,1
    ...
    131e:	8be50513          	addi	a0,a0,-1858 # 5bd8 <malloc+0xa00>
    1322:	5ff030ef          	jal	5120 <printf>
        exit(1);
    1326:	4505                	li	a0,1
    ...
    1344:	020a0a13          	addi	s4,s4,32 # 5360 <malloc+0x188>
    int n = write(fd, "xxx", 3);
    1348:	498d                	li	s3,3
    134a:	00005b97          	auipc	s7,0x5
    134e:	8aeb8b93          	addi	s7,s7,-1874 # 5bf8 <malloc+0xa20>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1352:	85da                	mv	a1,s6
    1354:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1388:	fdc50513          	addi	a0,a0,-36 # 5360 <malloc+0x188>
  ...
  exit(xstatus);
    ...
    13a2:	81250513          	addi	a0,a0,-2030 # 5bb0 <malloc+0x9d8>
    13a6:	57b030ef          	jal	5120 <printf>
      exit(1);
    13aa:	4505                	li	a0,1
    ...
    13bc:	84850513          	addi	a0,a0,-1976 # 5c00 <malloc+0xa28>
    13c0:	561030ef          	jal	5120 <printf>
      exit(1);
    13c4:	4505                	li	a0,1
...
00000000000013ca <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13da:	f3278793          	addi	a5,a5,-206 # 5308 <malloc+0x130>
    13de:	fcf43023          	sd	a5,-64(s0)
    13e2:	00005797          	auipc	a5,0x5
    13e6:	83e78793          	addi	a5,a5,-1986 # 5c20 <malloc+0xa48>
    13ea:	fcf43423          	sd	a5,-56(s0)
    13ee:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f2:	00005517          	auipc	a0,0x5
    13f6:	83650513          	addi	a0,a0,-1994 # 5c28 <malloc+0xa50>
  ...
  if(pid == 0) {
    ...
    141a:	81250513          	addi	a0,a0,-2030 # 5c28 <malloc+0xa50>
    ...
    1432:	81a50513          	addi	a0,a0,-2022 # 5c48 <malloc+0xa70>
    1436:	4eb030ef          	jal	5120 <printf>
      exit(1);
    143a:	4505                	li	a0,1
    ...
    1448:	75450513          	addi	a0,a0,1876 # 5b98 <malloc+0x9c0>
    144c:	4d5030ef          	jal	5120 <printf>
     exit(1);
    1450:	4505                	li	a0,1
    ...
    145c:	7d850513          	addi	a0,a0,2008 # 5c30 <malloc+0xa58>
    1460:	4c1030ef          	jal	5120 <printf>
      exit(1);
    1464:	4505                	li	a0,1
    ...
    1472:	e9a50513          	addi	a0,a0,-358 # 5308 <malloc+0x130>
  ...
  if(xstatus != 0)
    ...
    149a:	7c250513          	addi	a0,a0,1986 # 5c58 <malloc+0xa80>
    149e:	483030ef          	jal	5120 <printf>
      exit(1);
    14a2:	4505                	li	a0,1
    ...
    14ae:	7c650513          	addi	a0,a0,1990 # 5c70 <malloc+0xa98>
    14b2:	46f030ef          	jal	5120 <printf>
    14b6:	bfd1                	j	148a <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b8:	4581                	li	a1,0
    14ba:	00004517          	auipc	a0,0x4
    14be:	76e50513          	addi	a0,a0,1902 # 5c28 <malloc+0xa50>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14e0:	1fc50513          	addi	a0,a0,508 # 56d8 <malloc+0x500>
    14e4:	43d030ef          	jal	5120 <printf>
    exit(1);
    14e8:	4505                	li	a0,1
    ...
    14f4:	6c050513          	addi	a0,a0,1728 # 5bb0 <malloc+0x9d8>
    14f8:	429030ef          	jal	5120 <printf>
    exit(1);
    14fc:	4505                	li	a0,1
    14fe:	005030ef          	jal	4d02 <exit>
  unlink("echo-ok");
    1502:	00004517          	auipc	a0,0x4
    1506:	72650513          	addi	a0,a0,1830 # 5c28 <malloc+0xa50>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152c:	76050513          	addi	a0,a0,1888 # 5c88 <malloc+0xab0>
    1530:	3f1030ef          	jal	5120 <printf>
    exit(1);
    1534:	4505                	li	a0,1
...
0000000000001540 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	6ce50513          	addi	a0,a0,1742 # 5ca0 <malloc+0xac8>
    15da:	347030ef          	jal	5120 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42db0b13          	addi	s6,s6,1069 # 142d <exectest+0x63>
{
    ...
    1650:	66c50513          	addi	a0,a0,1644 # 5cb8 <malloc+0xae0>
    1654:	2cd030ef          	jal	5120 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	67050513          	addi	a0,a0,1648 # 5cd0 <malloc+0xaf8>
    1668:	2b9030ef          	jal	5120 <printf>
          return;
    ...
    1696:	65650513          	addi	a0,a0,1622 # 5ce8 <malloc+0xb10>
    169a:	287030ef          	jal	5120 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	63a50513          	addi	a0,a0,1594 # 5d08 <malloc+0xb30>
    16d6:	24b030ef          	jal	5120 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	46250513          	addi	a0,a0,1122 # 5b98 <malloc+0x9c0>
    173e:	1e3030ef          	jal	5120 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	5d650513          	addi	a0,a0,1494 # 5d20 <malloc+0xb48>
    1752:	1cf030ef          	jal	5120 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	5da50513          	addi	a0,a0,1498 # 5d38 <malloc+0xb60>
    1766:	1bb030ef          	jal	5120 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	3de50513          	addi	a0,a0,990 # 5b98 <malloc+0x9c0>
    17c2:	15f030ef          	jal	5120 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	3c650513          	addi	a0,a0,966 # 5b98 <malloc+0x9c0>
    17da:	147030ef          	jal	5120 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	52850513          	addi	a0,a0,1320 # 5d58 <malloc+0xb80>
    1838:	0e9030ef          	jal	5120 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	4c4030ef          	jal	4d02 <exit>
{
    ...
    1870:	4fc50513          	addi	a0,a0,1276 # 5d68 <malloc+0xb90>
    1874:	0ad030ef          	jal	5120 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	86250513          	addi	a0,a0,-1950 # 7108 <malloc+0x1f30>
    18ae:	073030ef          	jal	5120 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1930:	26c50513          	addi	a0,a0,620 # 5b98 <malloc+0x9c0>
    1934:	7ec030ef          	jal	5120 <printf>
      exit(1);
    1938:	4505                	li	a0,1
    ...
    195c:	2d850513          	addi	a0,a0,728 # 5c30 <malloc+0xa58>
    1960:	7c0030ef          	jal	5120 <printf>
          exit(1);
    1964:	4505                	li	a0,1
    ...
    19bc:	3d050513          	addi	a0,a0,976 # 5d88 <malloc+0xbb0>
    19c0:	760030ef          	jal	5120 <printf>
            exit(1);
    19c4:	4505                	li	a0,1
    ...
    19da:	3ca50513          	addi	a0,a0,970 # 5da0 <malloc+0xbc8>
    19de:	742030ef          	jal	5120 <printf>
        exit(1);
    19e2:	4505                	li	a0,1
    ...
    1a2a:	3a250513          	addi	a0,a0,930 # 5dc8 <malloc+0xbf0>
    1a2e:	6f2030ef          	jal	5120 <printf>
        exit(1);
    1a32:	4505                	li	a0,1
...
0000000000001aa4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ac6:	8b650513          	addi	a0,a0,-1866 # 5378 <malloc+0x1a0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b06:	876b0b13          	addi	s6,s6,-1930 # 5378 <malloc+0x1a0>
      link("cat", "x");
    1b0a:	00004c97          	auipc	s9,0x4
    1b0e:	2e6c8c93          	addi	s9,s9,742 # 5df0 <malloc+0xc18>
    ...
    1b1e:	07e50513          	addi	a0,a0,126 # 5b98 <malloc+0x9c0>
    1b22:	5fe030ef          	jal	5120 <printf>
    exit(1);
    1b26:	4505                	li	a0,1
...
0000000000001b9e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bca:	27a50513          	addi	a0,a0,634 # 5e40 <malloc+0xc68>
    1bce:	552030ef          	jal	5120 <printf>
    exit(1);
    1bd2:	4505                	li	a0,1
    ...
    1be2:	21a50513          	addi	a0,a0,538 # 5df8 <malloc+0xc20>
    1be6:	53a030ef          	jal	5120 <printf>
    exit(1);
    1bea:	4505                	li	a0,1
    ...
    1bf6:	21e50513          	addi	a0,a0,542 # 5e10 <malloc+0xc38>
    1bfa:	526030ef          	jal	5120 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c0a:	22250513          	addi	a0,a0,546 # 5e28 <malloc+0xc50>
    1c0e:	512030ef          	jal	5120 <printf>
    exit(1);
    1c12:	4505                	li	a0,1
...
0000000000001c44 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cac:	ef050513          	addi	a0,a0,-272 # 5b98 <malloc+0x9c0>
    1cb0:	470030ef          	jal	5120 <printf>
      exit(1);
    1cb4:	4505                	li	a0,1
    ...
    1cc6:	1a650513          	addi	a0,a0,422 # 5e68 <malloc+0xc90>
    1cca:	456030ef          	jal	5120 <printf>
      exit(1);
    1cce:	4505                	li	a0,1
...
0000000000001cda <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d3a:	e6250513          	addi	a0,a0,-414 # 5b98 <malloc+0x9c0>
    1d3e:	3e2030ef          	jal	5120 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
    ...
    1d5e:	12e50513          	addi	a0,a0,302 # 5e88 <malloc+0xcb0>
    1d62:	3be030ef          	jal	5120 <printf>
      exit(1);
    1d66:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dae:	0f650513          	addi	a0,a0,246 # 5ea0 <malloc+0xcc8>
    1db2:	36e030ef          	jal	5120 <printf>
    exit(1);
    1db6:	4505                	li	a0,1
    ...
    1dc2:	dda50513          	addi	a0,a0,-550 # 5b98 <malloc+0x9c0>
    1dc6:	35a030ef          	jal	5120 <printf>
    exit(1);
    1dca:	4505                	li	a0,1
...
0000000000001dd6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dec:	88078793          	addi	a5,a5,-1920 # 7668 <malloc+0x2490>
  ...
  exit(0);
    ...
    1e56:	07650513          	addi	a0,a0,118 # 5ec8 <malloc+0xcf0>
    1e5a:	2c6030ef          	jal	5120 <printf>
      exit(0);
    1e5e:	4501                	li	a0,0
    ...
    1e6a:	d3250513          	addi	a0,a0,-718 # 5b98 <malloc+0x9c0>
    1e6e:	2b2030ef          	jal	5120 <printf>
      exit(1);
    1e72:	4505                	li	a0,1
...
0000000000001e7e <manywrites>:
{
  ...
  exit(0);
    ...
    1ee4:	22850513          	addi	a0,a0,552 # 7108 <malloc+0x1f30>
    1ee8:	238030ef          	jal	5120 <printf>
      exit(1);
    1eec:	4505                	li	a0,1
    ...
    1f7c:	f7050513          	addi	a0,a0,-144 # 5ee8 <malloc+0xd10>
    1f80:	1a0030ef          	jal	5120 <printf>
            exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f94:	44850513          	addi	a0,a0,1096 # 53d8 <malloc+0x200>
    1f98:	188030ef          	jal	5120 <printf>
            exit(1);
    1f9c:	4505                	li	a0,1
...
0000000000001fb2 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2014:	bd878793          	addi	a5,a5,-1064 # 6be8 <malloc+0x1a10>
  ...
  if(ret != -1){
    ...
    2050:	eb450513          	addi	a0,a0,-332 # 5f00 <malloc+0xd28>
    2054:	0cc030ef          	jal	5120 <printf>
    exit(1);
    2058:	4505                	li	a0,1
    ...
    2066:	a5650513          	addi	a0,a0,-1450 # 5ab8 <malloc+0x8e0>
    206a:	0b6030ef          	jal	5120 <printf>
    exit(1);
    206e:	4505                	li	a0,1
    ...
    207c:	a6050513          	addi	a0,a0,-1440 # 5ad8 <malloc+0x900>
    2080:	0a0030ef          	jal	5120 <printf>
    exit(1);
    2084:	4505                	li	a0,1
    ...
    2094:	a6850513          	addi	a0,a0,-1432 # 5af8 <malloc+0x920>
    2098:	088030ef          	jal	5120 <printf>
    exit(1);
    209c:	4505                	li	a0,1
    ...
    20aa:	a7a50513          	addi	a0,a0,-1414 # 5b20 <malloc+0x948>
    20ae:	072030ef          	jal	5120 <printf>
    exit(1);
    20b2:	4505                	li	a0,1
...
00000000000020b8 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20e6:	e5e50513          	addi	a0,a0,-418 # 5f40 <malloc+0xd68>
  ...
  if(n >= 0){
    ...
    210e:	e5650513          	addi	a0,a0,-426 # 5f60 <malloc+0xd88>
    2112:	00e030ef          	jal	5120 <printf>
    exit(1);
    2116:	4505                	li	a0,1
    ...
    2124:	de850513          	addi	a0,a0,-536 # 5f08 <malloc+0xd30>
    2128:	7f9020ef          	jal	5120 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    2138:	dec50513          	addi	a0,a0,-532 # 5f20 <malloc+0xd48>
    213c:	7e5020ef          	jal	5120 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    2142:	3c1020ef          	jal	4d02 <exit>
    printf("open(rwsbrk) failed\n");
    2146:	00004517          	auipc	a0,0x4
    214a:	e0250513          	addi	a0,a0,-510 # 5f48 <malloc+0xd70>
    214e:	7d3020ef          	jal	5120 <printf>
    exit(1);
    2152:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2162:	de250513          	addi	a0,a0,-542 # 5f40 <malloc+0xd68>
    2166:	3ed020ef          	jal	4d52 <unlink>
  fd = open("README", O_RDONLY);
    216a:	4581                	li	a1,0
    216c:	00003517          	auipc	a0,0x3
    2170:	37450513          	addi	a0,a0,884 # 54e0 <malloc+0x308>
  ...
  if(n >= 0){
    ...
    2192:	e0250513          	addi	a0,a0,-510 # 5f90 <malloc+0xdb8>
    2196:	78b020ef          	jal	5120 <printf>
    exit(1);
    219a:	4505                	li	a0,1
    219c:	367020ef          	jal	4d02 <exit>
    printf("open(rwsbrk) failed\n");
    21a0:	00004517          	auipc	a0,0x4
    21a4:	da850513          	addi	a0,a0,-600 # 5f48 <malloc+0xd70>
    21a8:	779020ef          	jal	5120 <printf>
    exit(1);
    21ac:	4505                	li	a0,1
...
00000000000021be <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2212:	daa50513          	addi	a0,a0,-598 # 5fb8 <malloc+0xde0>
    2216:	70b020ef          	jal	5120 <printf>
    exit(1);
    221a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    226a:	d7250513          	addi	a0,a0,-654 # 5fd8 <malloc+0xe00>
    226e:	6b3020ef          	jal	5120 <printf>
    exit(1);
    2272:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22b4:	d8850513          	addi	a0,a0,-632 # 6038 <malloc+0xe60>
    22b8:	669020ef          	jal	5120 <printf>
    exit(1);
    22bc:	4505                	li	a0,1
    ...
    22ce:	d2e50513          	addi	a0,a0,-722 # 5ff8 <malloc+0xe20>
    22d2:	64f020ef          	jal	5120 <printf>
      exit(1);
    22d6:	4505                	li	a0,1
    ...
    22e2:	d3a50513          	addi	a0,a0,-710 # 6018 <malloc+0xe40>
    22e6:	63b020ef          	jal	5120 <printf>
    exit(1);
    22ea:	4505                	li	a0,1
...
000000000000230a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e4:	c7850513          	addi	a0,a0,-904 # 6058 <malloc+0xe80>
    23e8:	539020ef          	jal	5120 <printf>
    exit(1);
    23ec:	4505                	li	a0,1
    ...
    23f8:	cac50513          	addi	a0,a0,-852 # 60a0 <malloc+0xec8>
    23fc:	525020ef          	jal	5120 <printf>
    exit(1);
    2400:	4505                	li	a0,1
    ...
    2410:	cb450513          	addi	a0,a0,-844 # 60c0 <malloc+0xee8>
    2414:	50d020ef          	jal	5120 <printf>
    exit(1);
    2418:	4505                	li	a0,1
    ...
    2428:	cdc50513          	addi	a0,a0,-804 # 6100 <malloc+0xf28>
    242c:	4f5020ef          	jal	5120 <printf>
    exit(1);
    2430:	4505                	li	a0,1
    ...
    243c:	cf850513          	addi	a0,a0,-776 # 6130 <malloc+0xf58>
    2440:	4e1020ef          	jal	5120 <printf>
    exit(1);
    2444:	4505                	li	a0,1
    ...
    2454:	d1850513          	addi	a0,a0,-744 # 6168 <malloc+0xf90>
    2458:	4c9020ef          	jal	5120 <printf>
    exit(1);
    245c:	4505                	li	a0,1
...
0000000000002462 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2482:	d1250513          	addi	a0,a0,-750 # 6190 <malloc+0xfb8>
    2486:	0bd020ef          	jal	4d42 <open>
    248a:	84aa                	mv	s1,a0
  unlink("sbrk");
    248c:	00004517          	auipc	a0,0x4
    2490:	d0450513          	addi	a0,a0,-764 # 6190 <malloc+0xfb8>
  ...
  if(pipe((int *) a) != 0){
    ...
    24d0:	ccc50513          	addi	a0,a0,-820 # 6198 <malloc+0xfc0>
    24d4:	44d020ef          	jal	5120 <printf>
    exit(1);
    24d8:	4505                	li	a0,1
    ...
    24e4:	cd050513          	addi	a0,a0,-816 # 61b0 <malloc+0xfd8>
    24e8:	439020ef          	jal	5120 <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24f8:	7ac50513          	addi	a0,a0,1964 # 5ca0 <malloc+0xac8>
    24fc:	425020ef          	jal	5120 <printf>
    exit(1);
    2500:	4505                	li	a0,1
...
0000000000002506 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    251a:	cb250513          	addi	a0,a0,-846 # 61c8 <malloc+0xff0>
  ...
  close(fd);
    ...
    2552:	66250513          	addi	a0,a0,1634 # 5bb0 <malloc+0x9d8>
    2556:	3cb020ef          	jal	5120 <printf>
    exit(1);
    255a:	4505                	li	a0,1
...
0000000000002560 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2588:	b8450513          	addi	a0,a0,-1148 # 7108 <malloc+0x1f30>
    258c:	395020ef          	jal	5120 <printf>
    exit(1);
    2590:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c2:	b4a50513          	addi	a0,a0,-1206 # 7108 <malloc+0x1f30>
    25c6:	35b020ef          	jal	5120 <printf>
    exit(1);
    25ca:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2602:	b0a50513          	addi	a0,a0,-1270 # 7108 <malloc+0x1f30>
    2606:	31b020ef          	jal	5120 <printf>
    exit(1);
    260a:	4505                	li	a0,1
...
00000000000026ee <execout>:
{
  ...
  exit(0);
    ...
    272a:	9e250513          	addi	a0,a0,-1566 # 7108 <malloc+0x1f30>
    272e:	1f3020ef          	jal	5120 <printf>
      exit(1);
    2732:	4505                	li	a0,1
    ...
    2770:	b9c50513          	addi	a0,a0,-1124 # 5308 <malloc+0x130>
    2774:	faa43423          	sd	a0,-88(s0)
    2778:	00003797          	auipc	a5,0x3
    277c:	c0078793          	addi	a5,a5,-1024 # 5378 <malloc+0x1a0>
...
0000000000002796 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c6:	a8e50513          	addi	a0,a0,-1394 # 6250 <malloc+0x1078>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27dc:	af050513          	addi	a0,a0,-1296 # 62c8 <malloc+0x10f0>
  ...
  unlink("12345678901234");
    ...
    2860:	97450513          	addi	a0,a0,-1676 # 61d0 <malloc+0xff8>
    2864:	0bd020ef          	jal	5120 <printf>
    exit(1);
    2868:	4505                	li	a0,1
    ...
    2874:	9a850513          	addi	a0,a0,-1624 # 6218 <malloc+0x1040>
    2878:	0a9020ef          	jal	5120 <printf>
    exit(1);
    287c:	4505                	li	a0,1
    ...
    2888:	9fc50513          	addi	a0,a0,-1540 # 6280 <malloc+0x10a8>
    288c:	095020ef          	jal	5120 <printf>
    exit(1);
    2890:	4505                	li	a0,1
    ...
    289c:	a6050513          	addi	a0,a0,-1440 # 62f8 <malloc+0x1120>
    28a0:	081020ef          	jal	5120 <printf>
    exit(1);
    28a4:	4505                	li	a0,1
    ...
    28b0:	aac50513          	addi	a0,a0,-1364 # 6358 <malloc+0x1180>
    28b4:	06d020ef          	jal	5120 <printf>
    exit(1);
    28b8:	4505                	li	a0,1
    ...
    28c4:	af050513          	addi	a0,a0,-1296 # 63b0 <malloc+0x11d8>
    28c8:	059020ef          	jal	5120 <printf>
    exit(1);
    28cc:	4505                	li	a0,1
...
00000000000028d2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    2916:	ad650513          	addi	a0,a0,-1322 # 63e8 <malloc+0x1210>
    ...
    294c:	ab050513          	addi	a0,a0,-1360 # 63f8 <malloc+0x1220>
    2950:	7d0020ef          	jal	5120 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    29c4:	a2850513          	addi	a0,a0,-1496 # 63e8 <malloc+0x1210>
    29c8:	3a2020ef          	jal	4d6a <mkdir>
    29cc:	12050363          	beqz	a0,2af2 <diskfull+0x220>
  unlink("diskfulldir");
    29d0:	00004517          	auipc	a0,0x4
    29d4:	a1850513          	addi	a0,a0,-1512 # 63e8 <malloc+0x1210>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afa:	92250513          	addi	a0,a0,-1758 # 6418 <malloc+0x1240>
    2afe:	622020ef          	jal	5120 <printf>
...
0000000000002b04 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b60:	8f450513          	addi	a0,a0,-1804 # 6450 <malloc+0x1278>
    2b64:	5bc020ef          	jal	5120 <printf>
    exit(1);
    2b68:	4505                	li	a0,1
    ...
    2b74:	8f850513          	addi	a0,a0,-1800 # 6468 <malloc+0x1290>
    2b78:	5a8020ef          	jal	5120 <printf>
    exit(1);
    2b7c:	4505                	li	a0,1
    ...
    2b88:	91450513          	addi	a0,a0,-1772 # 6498 <malloc+0x12c0>
    2b8c:	594020ef          	jal	5120 <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2b9c:	92850513          	addi	a0,a0,-1752 # 64c0 <malloc+0x12e8>
    2ba0:	580020ef          	jal	5120 <printf>
    exit(1);
    2ba4:	4505                	li	a0,1
...
0000000000002baa <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2bfc:	fa050513          	addi	a0,a0,-96 # 5b98 <malloc+0x9c0>
    2c00:	520020ef          	jal	5120 <printf>
    exit(1);
    2c04:	4505                	li	a0,1
    ...
    2c10:	84450513          	addi	a0,a0,-1980 # 6450 <malloc+0x1278>
    2c14:	50c020ef          	jal	5120 <printf>
      exit(1);
    2c18:	4505                	li	a0,1
    ...
    2c24:	8b850513          	addi	a0,a0,-1864 # 64d8 <malloc+0x1300>
    2c28:	4f8020ef          	jal	5120 <printf>
      exit(1);
    2c2c:	4505                	li	a0,1
    ...
    2c38:	86450513          	addi	a0,a0,-1948 # 6498 <malloc+0x12c0>
    2c3c:	4e4020ef          	jal	5120 <printf>
      exit(1);
    2c40:	4505                	li	a0,1
...
0000000000002c56 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb2:	7a250513          	addi	a0,a0,1954 # 6450 <malloc+0x1278>
    2cb6:	46a020ef          	jal	5120 <printf>
    exit(1);
    2cba:	4505                	li	a0,1
    ...
    2cc6:	83650513          	addi	a0,a0,-1994 # 64f8 <malloc+0x1320>
    2cca:	456020ef          	jal	5120 <printf>
    exit(1);
    2cce:	4505                	li	a0,1
    ...
    2cda:	84250513          	addi	a0,a0,-1982 # 6518 <malloc+0x1340>
    2cde:	442020ef          	jal	5120 <printf>
    exit(1);
    2ce2:	4505                	li	a0,1
    ...
    2cee:	84650513          	addi	a0,a0,-1978 # 6530 <malloc+0x1358>
    2cf2:	42e020ef          	jal	5120 <printf>
    exit(1);
    2cf6:	4505                	li	a0,1
...
0000000000002cfc <subdir>:
{
  ...
  unlink("ff");
    ...
    2d0e:	96e50513          	addi	a0,a0,-1682 # 6678 <malloc+0x14a0>
    2d12:	040020ef          	jal	4d52 <unlink>
  if(mkdir("dd") != 0){
    2d16:	00004517          	auipc	a0,0x4
    2d1a:	83250513          	addi	a0,a0,-1998 # 6548 <malloc+0x1370>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d2e:	83e50513          	addi	a0,a0,-1986 # 6568 <malloc+0x1390>
  ...
  write(fd, "ff", 2);
    ...
    2d42:	93a58593          	addi	a1,a1,-1734 # 6678 <malloc+0x14a0>
  ...
  if(unlink("dd") >= 0){
    ...
    2d54:	7f850513          	addi	a0,a0,2040 # 6548 <malloc+0x1370>
    2d58:	7fb010ef          	jal	4d52 <unlink>
    2d5c:	2c055963          	bgez	a0,302e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d60:	00004517          	auipc	a0,0x4
    2d64:	86050513          	addi	a0,a0,-1952 # 65c0 <malloc+0x13e8>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d78:	87450513          	addi	a0,a0,-1932 # 65e8 <malloc+0x1410>
  ...
  write(fd, "FF", 2);
    ...
    2d8c:	89058593          	addi	a1,a1,-1904 # 6618 <malloc+0x1440>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da0:	88450513          	addi	a0,a0,-1916 # 6620 <malloc+0x1448>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e86:	76650513          	addi	a0,a0,1894 # 65e8 <malloc+0x1410>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9a:	96a50513          	addi	a0,a0,-1686 # 6800 <malloc+0x1628>
  ...
  if(unlink("dd") < 0){
    ...
    300c:	54850513          	addi	a0,a0,1352 # 6550 <malloc+0x1378>
    3010:	110020ef          	jal	5120 <printf>
    exit(1);
    3014:	4505                	li	a0,1
    ...
    3020:	55450513          	addi	a0,a0,1364 # 6570 <malloc+0x1398>
    3024:	0fc020ef          	jal	5120 <printf>
    exit(1);
    3028:	4505                	li	a0,1
    ...
    3034:	56050513          	addi	a0,a0,1376 # 6590 <malloc+0x13b8>
    3038:	0e8020ef          	jal	5120 <printf>
    exit(1);
    303c:	4505                	li	a0,1
    ...
    3048:	58450513          	addi	a0,a0,1412 # 65c8 <malloc+0x13f0>
    304c:	0d4020ef          	jal	5120 <printf>
    exit(1);
    3050:	4505                	li	a0,1
    ...
    305c:	5a050513          	addi	a0,a0,1440 # 65f8 <malloc+0x1420>
    3060:	0c0020ef          	jal	5120 <printf>
    exit(1);
    3064:	4505                	li	a0,1
    ...
    3070:	5c450513          	addi	a0,a0,1476 # 6630 <malloc+0x1458>
    3074:	0ac020ef          	jal	5120 <printf>
    exit(1);
    3078:	4505                	li	a0,1
    ...
    3084:	5d050513          	addi	a0,a0,1488 # 6650 <malloc+0x1478>
    3088:	098020ef          	jal	5120 <printf>
    exit(1);
    308c:	4505                	li	a0,1
    ...
    3098:	5ec50513          	addi	a0,a0,1516 # 6680 <malloc+0x14a8>
    309c:	084020ef          	jal	5120 <printf>
    exit(1);
    30a0:	4505                	li	a0,1
    ...
    30ac:	60050513          	addi	a0,a0,1536 # 66a8 <malloc+0x14d0>
    30b0:	070020ef          	jal	5120 <printf>
    exit(1);
    30b4:	4505                	li	a0,1
    ...
    30c0:	60c50513          	addi	a0,a0,1548 # 66c8 <malloc+0x14f0>
    30c4:	05c020ef          	jal	5120 <printf>
    exit(1);
    30c8:	4505                	li	a0,1
    ...
    30d4:	62050513          	addi	a0,a0,1568 # 66f0 <malloc+0x1518>
    30d8:	048020ef          	jal	5120 <printf>
    exit(1);
    30dc:	4505                	li	a0,1
    ...
    30e8:	63450513          	addi	a0,a0,1588 # 6718 <malloc+0x1540>
    30ec:	034020ef          	jal	5120 <printf>
    exit(1);
    30f0:	4505                	li	a0,1
    ...
    30fc:	65050513          	addi	a0,a0,1616 # 6748 <malloc+0x1570>
    3100:	020020ef          	jal	5120 <printf>
    exit(1);
    3104:	4505                	li	a0,1
    ...
    3110:	66c50513          	addi	a0,a0,1644 # 6778 <malloc+0x15a0>
    3114:	00c020ef          	jal	5120 <printf>
    exit(1);
    3118:	4505                	li	a0,1
    ...
    3124:	67050513          	addi	a0,a0,1648 # 6790 <malloc+0x15b8>
    3128:	7f9010ef          	jal	5120 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    3138:	67c50513          	addi	a0,a0,1660 # 67b0 <malloc+0x15d8>
    313c:	7e5010ef          	jal	5120 <printf>
    exit(1);
    3140:	4505                	li	a0,1
    ...
    314c:	68850513          	addi	a0,a0,1672 # 67d0 <malloc+0x15f8>
    3150:	7d1010ef          	jal	5120 <printf>
    exit(1);
    3154:	4505                	li	a0,1
    ...
    3160:	6b450513          	addi	a0,a0,1716 # 6810 <malloc+0x1638>
    3164:	7bd010ef          	jal	5120 <printf>
    exit(1);
    3168:	4505                	li	a0,1
    ...
    3174:	6d050513          	addi	a0,a0,1744 # 6840 <malloc+0x1668>
    3178:	7a9010ef          	jal	5120 <printf>
    exit(1);
    317c:	4505                	li	a0,1
    ...
    3188:	6dc50513          	addi	a0,a0,1756 # 6860 <malloc+0x1688>
    318c:	795010ef          	jal	5120 <printf>
    exit(1);
    3190:	4505                	li	a0,1
    ...
    319c:	6e850513          	addi	a0,a0,1768 # 6880 <malloc+0x16a8>
    31a0:	781010ef          	jal	5120 <printf>
    exit(1);
    31a4:	4505                	li	a0,1
    ...
    31b0:	6f450513          	addi	a0,a0,1780 # 68a0 <malloc+0x16c8>
    31b4:	76d010ef          	jal	5120 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
    ...
    31c4:	71050513          	addi	a0,a0,1808 # 68d0 <malloc+0x16f8>
    31c8:	759010ef          	jal	5120 <printf>
    exit(1);
    31cc:	4505                	li	a0,1
    ...
    31d8:	72450513          	addi	a0,a0,1828 # 68f8 <malloc+0x1720>
    31dc:	745010ef          	jal	5120 <printf>
    exit(1);
    31e0:	4505                	li	a0,1
    ...
    31ec:	73850513          	addi	a0,a0,1848 # 6920 <malloc+0x1748>
    31f0:	731010ef          	jal	5120 <printf>
    exit(1);
    31f4:	4505                	li	a0,1
    ...
    3200:	74c50513          	addi	a0,a0,1868 # 6948 <malloc+0x1770>
    3204:	71d010ef          	jal	5120 <printf>
    exit(1);
    3208:	4505                	li	a0,1
    ...
    3214:	75850513          	addi	a0,a0,1880 # 6968 <malloc+0x1790>
    3218:	709010ef          	jal	5120 <printf>
    exit(1);
    321c:	4505                	li	a0,1
    ...
    3228:	76450513          	addi	a0,a0,1892 # 6988 <malloc+0x17b0>
    322c:	6f5010ef          	jal	5120 <printf>
    exit(1);
    3230:	4505                	li	a0,1
    ...
    323c:	77850513          	addi	a0,a0,1912 # 69b0 <malloc+0x17d8>
    3240:	6e1010ef          	jal	5120 <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	78450513          	addi	a0,a0,1924 # 69d0 <malloc+0x17f8>
    3254:	6cd010ef          	jal	5120 <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	79050513          	addi	a0,a0,1936 # 69f0 <malloc+0x1818>
    3268:	6b9010ef          	jal	5120 <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	7a450513          	addi	a0,a0,1956 # 6a18 <malloc+0x1840>
    327c:	6a5010ef          	jal	5120 <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	42050513          	addi	a0,a0,1056 # 66a8 <malloc+0x14d0>
    3290:	691010ef          	jal	5120 <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	79c50513          	addi	a0,a0,1948 # 6a38 <malloc+0x1860>
    32a4:	67d010ef          	jal	5120 <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	7a850513          	addi	a0,a0,1960 # 6a58 <malloc+0x1880>
    32b8:	669010ef          	jal	5120 <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	7c450513          	addi	a0,a0,1988 # 6a88 <malloc+0x18b0>
    32cc:	655010ef          	jal	5120 <printf>
    exit(1);
    32d0:	4505                	li	a0,1
    ...
    32dc:	7d050513          	addi	a0,a0,2000 # 6aa8 <malloc+0x18d0>
    32e0:	641010ef          	jal	5120 <printf>
    exit(1);
    32e4:	4505                	li	a0,1
...
00000000000032ea <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3376:	75650513          	addi	a0,a0,1878 # 6ac8 <malloc+0x18f0>
    337a:	5a7010ef          	jal	5120 <printf>
    exit(1);
    337e:	4505                	li	a0,1
    ...
    338a:	75a50513          	addi	a0,a0,1882 # 6ae0 <malloc+0x1908>
    338e:	593010ef          	jal	5120 <printf>
    exit(1);
    3392:	4505                	li	a0,1
    ...
    339e:	75e50513          	addi	a0,a0,1886 # 6af8 <malloc+0x1920>
    33a2:	57f010ef          	jal	5120 <printf>
    exit(1);
    33a6:	4505                	li	a0,1
    ...
    33b2:	76250513          	addi	a0,a0,1890 # 6b10 <malloc+0x1938>
    33b6:	56b010ef          	jal	5120 <printf>
    exit(1);
    33ba:	4505                	li	a0,1
    ...
    33c6:	0fe50513          	addi	a0,a0,254 # 64c0 <malloc+0x12e8>
    33ca:	557010ef          	jal	5120 <printf>
    exit(1);
    33ce:	4505                	li	a0,1
    ...
    33da:	75a50513          	addi	a0,a0,1882 # 6b30 <malloc+0x1958>
    33de:	543010ef          	jal	5120 <printf>
    exit(1);
    33e2:	4505                	li	a0,1
    ...
    33ee:	76e50513          	addi	a0,a0,1902 # 6b58 <malloc+0x1980>
    33f2:	52f010ef          	jal	5120 <printf>
    exit(1);
    33f6:	4505                	li	a0,1
    ...
    3402:	77a50513          	addi	a0,a0,1914 # 6b78 <malloc+0x19a0>
    3406:	51b010ef          	jal	5120 <printf>
    exit(1);
    340a:	4505                	li	a0,1
...
0000000000003410 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3426:	77650513          	addi	a0,a0,1910 # 6b98 <malloc+0x19c0>
  ...
  if(chdir("dirfile") == 0){
    ...
    343a:	76250513          	addi	a0,a0,1890 # 6b98 <malloc+0x19c0>
    343e:	135010ef          	jal	4d72 <chdir>
    3442:	c569                	beqz	a0,350c <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3444:	4581                	li	a1,0
    3446:	00003517          	auipc	a0,0x3
    344a:	79a50513          	addi	a0,a0,1946 # 6be0 <malloc+0x1a08>
  ...
  fd = open(".", 0);
    ...
    34ca:	52a50513          	addi	a0,a0,1322 # 59f0 <malloc+0x818>
    34ce:	075010ef          	jal	4d42 <open>
    34d2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d4:	4605                	li	a2,1
    34d6:	00002597          	auipc	a1,0x2
    34da:	ea258593          	addi	a1,a1,-350 # 5378 <malloc+0x1a0>
  ...
  close(fd);
    ...
    34fe:	6a650513          	addi	a0,a0,1702 # 6ba0 <malloc+0x19c8>
    3502:	41f010ef          	jal	5120 <printf>
    exit(1);
    3506:	4505                	li	a0,1
    ...
    3512:	6b250513          	addi	a0,a0,1714 # 6bc0 <malloc+0x19e8>
    3516:	40b010ef          	jal	5120 <printf>
    exit(1);
    351a:	4505                	li	a0,1
    ...
    3526:	6ce50513          	addi	a0,a0,1742 # 6bf0 <malloc+0x1a18>
    352a:	3f7010ef          	jal	5120 <printf>
    exit(1);
    352e:	4505                	li	a0,1
    ...
    353a:	6ba50513          	addi	a0,a0,1722 # 6bf0 <malloc+0x1a18>
    353e:	3e3010ef          	jal	5120 <printf>
    exit(1);
    3542:	4505                	li	a0,1
    ...
    354e:	6ce50513          	addi	a0,a0,1742 # 6c18 <malloc+0x1a40>
    3552:	3cf010ef          	jal	5120 <printf>
    exit(1);
    3556:	4505                	li	a0,1
    ...
    3562:	6e250513          	addi	a0,a0,1762 # 6c40 <malloc+0x1a68>
    3566:	3bb010ef          	jal	5120 <printf>
    exit(1);
    356a:	4505                	li	a0,1
    ...
    3576:	6f650513          	addi	a0,a0,1782 # 6c68 <malloc+0x1a90>
    357a:	3a7010ef          	jal	5120 <printf>
    exit(1);
    357e:	4505                	li	a0,1
    ...
    358a:	70a50513          	addi	a0,a0,1802 # 6c90 <malloc+0x1ab8>
    358e:	393010ef          	jal	5120 <printf>
    exit(1);
    3592:	4505                	li	a0,1
    ...
    359e:	71650513          	addi	a0,a0,1814 # 6cb0 <malloc+0x1ad8>
    35a2:	37f010ef          	jal	5120 <printf>
    exit(1);
    35a6:	4505                	li	a0,1
    ...
    35b2:	72a50513          	addi	a0,a0,1834 # 6cd8 <malloc+0x1b00>
    35b6:	36b010ef          	jal	5120 <printf>
    exit(1);
    35ba:	4505                	li	a0,1
...
00000000000035c0 <iref>:
{
    ...
    35e0:	714a8a93          	addi	s5,s5,1812 # 6cf0 <malloc+0x1b18>
    mkdir("");
    35e4:	00003497          	auipc	s1,0x3
    35e8:	21448493          	addi	s1,s1,532 # 67f8 <malloc+0x1620>
    link("README", "");
    35ec:	00002b17          	auipc	s6,0x2
    35f0:	ef4b0b13          	addi	s6,s6,-268 # 54e0 <malloc+0x308>
    fd = open("", O_CREATE);
    35f4:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35f8:	00003997          	auipc	s3,0x3
    35fc:	5f098993          	addi	s3,s3,1520 # 6be8 <malloc+0x1a10>
    3600:	a835                	j	363c <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3602:	85de                	mv	a1,s7
    3604:	00003517          	auipc	a0,0x3
    3608:	6f450513          	addi	a0,a0,1780 # 6cf8 <malloc+0x1b20>
    360c:	315010ef          	jal	5120 <printf>
      exit(1);
    3610:	4505                	li	a0,1
    ...
    361c:	6f850513          	addi	a0,a0,1784 # 6d10 <malloc+0x1b38>
    3620:	301010ef          	jal	5120 <printf>
      exit(1);
    3624:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3680:	e9498993          	addi	s3,s3,-364 # 6510 <malloc+0x1338>
    unlink("irefd");
    3684:	00003917          	auipc	s2,0x3
    3688:	66c90913          	addi	s2,s2,1644 # 6cf0 <malloc+0x1b18>
    chdir("..");
    368c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a0:	e1c50513          	addi	a0,a0,-484 # 64b8 <malloc+0x12e0>
...
00000000000036be <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36ce:	65e50513          	addi	a0,a0,1630 # 6d28 <malloc+0x1b50>
  ...
  if(pid == 0){
    ...
    36ea:	64250513          	addi	a0,a0,1602 # 6d28 <malloc+0x1b50>
    ...
    36fc:	65050513          	addi	a0,a0,1616 # 6d48 <malloc+0x1b70>
    3700:	221010ef          	jal	5120 <printf>
      exit(1);
    3704:	4505                	li	a0,1
    ...
    3710:	62450513          	addi	a0,a0,1572 # 6d30 <malloc+0x1b58>
    3714:	20d010ef          	jal	5120 <printf>
    exit(1);
    3718:	4505                	li	a0,1
    ...
    3724:	47850513          	addi	a0,a0,1144 # 5b98 <malloc+0x9c0>
    3728:	1f9010ef          	jal	5120 <printf>
    exit(1);
    372c:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3742:	5ea50513          	addi	a0,a0,1514 # 6d28 <malloc+0x1b50>
    3746:	60c010ef          	jal	4d52 <unlink>
    374a:	c919                	beqz	a0,3760 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    374c:	85a6                	mv	a1,s1
    374e:	00002517          	auipc	a0,0x2
    3752:	63a50513          	addi	a0,a0,1594 # 5d88 <malloc+0xbb0>
    3756:	1cb010ef          	jal	5120 <printf>
    exit(1);
    375a:	4505                	li	a0,1
...
0000000000003770 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3780:	5f450513          	addi	a0,a0,1524 # 6d70 <malloc+0x1b98>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a0:	5d450513          	addi	a0,a0,1492 # 6d70 <malloc+0x1b98>
  ...
  sleep(10); // one second
    ...
    37c8:	59450513          	addi	a0,a0,1428 # 5d58 <malloc+0xb80>
    37cc:	155010ef          	jal	5120 <printf>
    exit(1);
    37d0:	4505                	li	a0,1
    37d2:	530010ef          	jal	4d02 <exit>
      int fd = open("stopforking", 0);
    37d6:	00003497          	auipc	s1,0x3
    37da:	59a48493          	addi	s1,s1,1434 # 6d70 <malloc+0x1b98>
    37de:	4581                	li	a1,0
    37e0:	8526                	mv	a0,s1
    ...
    37fa:	57a50513          	addi	a0,a0,1402 # 6d70 <malloc+0x1b98>
...
000000000000380e <killstatus>:
{
  ...
  exit(0);
    ...
    3868:	33450513          	addi	a0,a0,820 # 5b98 <malloc+0x9c0>
    386c:	0b5010ef          	jal	5120 <printf>
      exit(1);
    3870:	4505                	li	a0,1
    ...
    3882:	50250513          	addi	a0,a0,1282 # 6d80 <malloc+0x1ba8>
    3886:	09b010ef          	jal	5120 <printf>
       exit(1);
    388a:	4505                	li	a0,1
...
0000000000003890 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b6:	4a650513          	addi	a0,a0,1190 # 5d58 <malloc+0xb80>
    38ba:	067010ef          	jal	5120 <printf>
    exit(1);
    38be:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38d8:	2c450513          	addi	a0,a0,708 # 5b98 <malloc+0x9c0>
    38dc:	045010ef          	jal	5120 <printf>
    exit(1);
    38e0:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3908:	a7458593          	addi	a1,a1,-1420 # 5378 <malloc+0x1a0>
    ...
    392a:	27250513          	addi	a0,a0,626 # 5b98 <malloc+0x9c0>
    392e:	7f2010ef          	jal	5120 <printf>
     exit(1);
    3932:	4505                	li	a0,1
    ...
    393e:	46650513          	addi	a0,a0,1126 # 6da0 <malloc+0x1bc8>
    3942:	7de010ef          	jal	5120 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    396e:	44e50513          	addi	a0,a0,1102 # 6db8 <malloc+0x1be0>
    3972:	7ae010ef          	jal	5120 <printf>
}
  ...
  printf("kill... ");
    ...
    3992:	44250513          	addi	a0,a0,1090 # 6dd0 <malloc+0x1bf8>
    3996:	78a010ef          	jal	5120 <printf>
  kill(pid1);
    399a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b0:	43450513          	addi	a0,a0,1076 # 6de0 <malloc+0x1c08>
    39b4:	76c010ef          	jal	5120 <printf>
  wait(0);
    39b8:	4501                	li	a0,0
...
00000000000039cc <reparent>:
{
  ...
  exit(0);
    ...
    3a10:	18c50513          	addi	a0,a0,396 # 5b98 <malloc+0x9c0>
    3a14:	70c010ef          	jal	5120 <printf>
      exit(1);
    3a18:	4505                	li	a0,1
    ...
    3a24:	30050513          	addi	a0,a0,768 # 5d20 <malloc+0xb48>
    3a28:	6f8010ef          	jal	5120 <printf>
        exit(1);
    3a2c:	4505                	li	a0,1
...
0000000000003a4c <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a88:	21c50513          	addi	a0,a0,540 # 5ca0 <malloc+0xac8>
    3a8c:	694010ef          	jal	5120 <printf>
    exit(1);
    3a90:	4505                	li	a0,1
    ...
    3aac:	8d058593          	addi	a1,a1,-1840 # 5378 <malloc+0x1a0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3b50:	2a450513          	addi	a0,a0,676 # 6df0 <malloc+0x1c18>
    3b54:	5cc010ef          	jal	5120 <printf>
    exit(1);
    3b58:	4505                	li	a0,1
    ...
    3b64:	03850513          	addi	a0,a0,56 # 5b98 <malloc+0x9c0>
    3b68:	5b8010ef          	jal	5120 <printf>
    exit(1);
    3b6c:	4505                	li	a0,1
    ...
    3ba0:	27450513          	addi	a0,a0,628 # 6e10 <malloc+0x1c38>
    3ba4:	57c010ef          	jal	5120 <printf>
    exit(1);
    3ba8:	4505                	li	a0,1
...
0000000000003bb4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3bf8:	6084                	ld	s1,0(s1)
      free(m1);
    3bfa:	558010ef          	jal	5152 <free>
    while(m1){
    3bfe:	fce5                	bnez	s1,3bf6 <mem+0x42>
    m1 = malloc(1024*20);
    3c00:	6515                	lui	a0,0x5
    3c02:	5d6010ef          	jal	51d8 <malloc>
    if(m1 == 0){
    3c06:	c511                	beqz	a0,3c12 <mem+0x5e>
    free(m1);
    3c08:	54a010ef          	jal	5152 <free>
    exit(0);
    3c0c:	4501                	li	a0,0
    ...
    3c18:	22c50513          	addi	a0,a0,556 # 6e40 <malloc+0x1c68>
    3c1c:	504010ef          	jal	5120 <printf>
      exit(1);
    3c20:	4505                	li	a0,1
...
0000000000003c2c <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c3c:	22850513          	addi	a0,a0,552 # 6e60 <malloc+0x1c88>
    3c40:	112010ef          	jal	4d52 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c44:	20200593          	li	a1,514
    3c48:	00003517          	auipc	a0,0x3
    3c4c:	21850513          	addi	a0,a0,536 # 6e60 <malloc+0x1c88>
  ...
  if(pid == 0) {
    ...
    3cc0:	1b450513          	addi	a0,a0,436 # 6e70 <malloc+0x1c98>
    3cc4:	45c010ef          	jal	5120 <printf>
    exit(1);
    3cc8:	4505                	li	a0,1
    ...
    3cda:	1c250513          	addi	a0,a0,450 # 6e98 <malloc+0x1cc0>
    3cde:	442010ef          	jal	5120 <printf>
      exit(1);
    3ce2:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d12:	15250513          	addi	a0,a0,338 # 6e60 <malloc+0x1c88>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d56:	16650513          	addi	a0,a0,358 # 6eb8 <malloc+0x1ce0>
    3d5a:	3c6010ef          	jal	5120 <printf>
    exit(1);
    3d5e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d86:	0de50513          	addi	a0,a0,222 # 6e60 <malloc+0x1c88>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3da8:	13c50513          	addi	a0,a0,316 # 6ee0 <malloc+0x1d08>
    3dac:	374010ef          	jal	5120 <printf>
    exit(1);
    3db0:	4505                	li	a0,1
...
0000000000003dbc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3de0:	11c78793          	addi	a5,a5,284 # 6ef8 <malloc+0x1d20>
    3de4:	f6f43823          	sd	a5,-144(s0)
    3de8:	00003797          	auipc	a5,0x3
    3dec:	11878793          	addi	a5,a5,280 # 6f00 <malloc+0x1d28>
    3df0:	f6f43c23          	sd	a5,-136(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	11478793          	addi	a5,a5,276 # 6f08 <malloc+0x1d30>
    3dfc:	f8f43023          	sd	a5,-128(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	11078793          	addi	a5,a5,272 # 6f10 <malloc+0x1d38>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e6a:	d3250513          	addi	a0,a0,-718 # 5b98 <malloc+0x9c0>
    3e6e:	2b2010ef          	jal	5120 <printf>
      exit(1);
    3e72:	4505                	li	a0,1
    ...
    3eca:	d6a50513          	addi	a0,a0,-662 # 5c30 <malloc+0xa58>
    3ece:	252010ef          	jal	5120 <printf>
        exit(1);
    3ed2:	4505                	li	a0,1
    3ed4:	62f000ef          	jal	4d02 <exit>
          printf("write failed %d\n", n);
    3ed8:	00003517          	auipc	a0,0x3
    3edc:	04050513          	addi	a0,a0,64 # 6f18 <malloc+0x1d40>
    3ee0:	240010ef          	jal	5120 <printf>
          exit(1);
    3ee4:	4505                	li	a0,1
    ...
    3ef6:	03e50513          	addi	a0,a0,62 # 6f30 <malloc+0x1d58>
    3efa:	226010ef          	jal	5120 <printf>
          exit(1);
    3efe:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f60:	fe450513          	addi	a0,a0,-28 # 6f40 <malloc+0x1d68>
    3f64:	1bc010ef          	jal	5120 <printf>
      exit(1);
    3f68:	4505                	li	a0,1
...
0000000000003f8c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fce:	f8ed0d13          	addi	s10,s10,-114 # 6f58 <malloc+0x1d80>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    4022:	f4250513          	addi	a0,a0,-190 # 6f60 <malloc+0x1d88>
    4026:	0fa010ef          	jal	5120 <printf>
        exit(1);
    402a:	4505                	li	a0,1
    ...
    4038:	f2450513          	addi	a0,a0,-220 # 6f58 <malloc+0x1d80>
  ...
  fd = open(".", 0);
    ...
    4060:	99450513          	addi	a0,a0,-1644 # 59f0 <malloc+0x818>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40ce:	eb650513          	addi	a0,a0,-330 # 6f80 <malloc+0x1da8>
    40d2:	04e010ef          	jal	5120 <printf>
        exit(1);
    40d6:	4505                	li	a0,1
    ...
    40e6:	ebe50513          	addi	a0,a0,-322 # 6fa0 <malloc+0x1dc8>
    40ea:	036010ef          	jal	5120 <printf>
        exit(1);
    40ee:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    411a:	eb250513          	addi	a0,a0,-334 # 6fc8 <malloc+0x1df0>
    411e:	002010ef          	jal	5120 <printf>
    exit(1);
    4122:	4505                	li	a0,1
    ...
    412e:	a6e50513          	addi	a0,a0,-1426 # 5b98 <malloc+0x9c0>
    4132:	7ef000ef          	jal	5120 <printf>
      exit(1);
    4136:	4505                	li	a0,1
...
000000000000426e <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4288:	d7c50513          	addi	a0,a0,-644 # 7000 <malloc+0x1e28>
    428c:	2c7000ef          	jal	4d52 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4290:	20200593          	li	a1,514
    4294:	00003517          	auipc	a0,0x3
    4298:	d6c50513          	addi	a0,a0,-660 # 7000 <malloc+0x1e28>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42e0:	d2450513          	addi	a0,a0,-732 # 7000 <malloc+0x1e28>
  ...
  for(i = 0; ; i++){
    ...
    433a:	cda50513          	addi	a0,a0,-806 # 7010 <malloc+0x1e38>
    433e:	5e3000ef          	jal	5120 <printf>
    exit(1);
    4342:	4505                	li	a0,1
    ...
    434e:	ce650513          	addi	a0,a0,-794 # 7030 <malloc+0x1e58>
    4352:	5cf000ef          	jal	5120 <printf>
      exit(1);
    4356:	4505                	li	a0,1
    ...
    4362:	cf250513          	addi	a0,a0,-782 # 7050 <malloc+0x1e78>
    4366:	5bb000ef          	jal	5120 <printf>
    exit(1);
    436a:	4505                	li	a0,1
    ...
    4376:	cfe50513          	addi	a0,a0,-770 # 7070 <malloc+0x1e98>
    437a:	5a7000ef          	jal	5120 <printf>
      exit(1);
    437e:	4505                	li	a0,1
    ...
    438a:	d0a50513          	addi	a0,a0,-758 # 7090 <malloc+0x1eb8>
    438e:	593000ef          	jal	5120 <printf>
      exit(1);
    4392:	4505                	li	a0,1
    ...
    439e:	d0e50513          	addi	a0,a0,-754 # 70a8 <malloc+0x1ed0>
    43a2:	57f000ef          	jal	5120 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43c0:	c4450513          	addi	a0,a0,-956 # 7000 <malloc+0x1e28>
    ...
    43e2:	cea50513          	addi	a0,a0,-790 # 70c8 <malloc+0x1ef0>
    43e6:	53b000ef          	jal	5120 <printf>
    exit(1);
    43ea:	4505                	li	a0,1
...
00000000000043f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    4400:	cec50513          	addi	a0,a0,-788 # 70e8 <malloc+0x1f10>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4426:	cc650513          	addi	a0,a0,-826 # 70e8 <malloc+0x1f10>
  ...
  close(fd);
    ...
    4480:	e8c50513          	addi	a0,a0,-372 # 5308 <malloc+0x130>
    4484:	0b7000ef          	jal	4d3a <exec>
    fd = open("bigarg-ok", O_CREATE);
    4488:	20000593          	li	a1,512
    448c:	00003517          	auipc	a0,0x3
    4490:	c5c50513          	addi	a0,a0,-932 # 70e8 <malloc+0x1f10>
    ...
    44a8:	c5450513          	addi	a0,a0,-940 # 70f8 <malloc+0x1f20>
    44ac:	475000ef          	jal	5120 <printf>
    exit(1);
    44b0:	4505                	li	a0,1
    ...
    44c0:	c5c50513          	addi	a0,a0,-932 # 7118 <malloc+0x1f40>
    44c4:	45d000ef          	jal	5120 <printf>
    exit(1);
    44c8:	4505                	li	a0,1
...
00000000000044ce <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    44f0:	c4c50513          	addi	a0,a0,-948 # 7138 <malloc+0x1f60>
    44f4:	42d000ef          	jal	5120 <printf>
  for(nfiles = 0; ; nfiles++){
    44f8:	4481                	li	s1,0
    name[0] = 'f';
    ...
    45a6:	ba650513          	addi	a0,a0,-1114 # 7148 <malloc+0x1f70>
    45aa:	377000ef          	jal	5120 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    45c6:	b9650513          	addi	a0,a0,-1130 # 7158 <malloc+0x1f80>
    45ca:	357000ef          	jal	5120 <printf>
    name[0] = 'f';
  ...
  printf("fsfull test finished\n");
    ...
    4684:	af850513          	addi	a0,a0,-1288 # 7178 <malloc+0x1fa0>
    4688:	299000ef          	jal	5120 <printf>
}
    ...
    46d6:	a9650513          	addi	a0,a0,-1386 # 7168 <malloc+0x1f90>
    46da:	247000ef          	jal	5120 <printf>
    close(fd);
    46de:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4700:	a9450513          	addi	a0,a0,-1388 # 7190 <malloc+0x1fb8>
    4704:	21d000ef          	jal	5120 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4724:	a9850513          	addi	a0,a0,-1384 # 71b8 <malloc+0x1fe0>
    4728:	1f9000ef          	jal	5120 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4744:	a6050513          	addi	a0,a0,-1440 # 71a0 <malloc+0x1fc8>
    4748:	1d9000ef          	jal	5120 <printf>
    exit(1);
    474c:	4505                	li	a0,1
    ...
    4760:	a6450513          	addi	a0,a0,-1436 # 71c0 <malloc+0x1fe8>
    4764:	1bd000ef          	jal	5120 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    47b8:	a1450513          	addi	a0,a0,-1516 # 71c8 <malloc+0x1ff0>
    47bc:	165000ef          	jal	5120 <printf>
          return 1;
    47c0:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    481c:	b60a0a13          	addi	s4,s4,-1184 # 5378 <malloc+0x1a0>
      uint64 a = (uint64) sbrk(4096);
    4820:	854a                	mv	a0,s2
    ...
    4844:	9e050513          	addi	a0,a0,-1568 # 7220 <malloc+0x2048>
    4848:	0d9000ef          	jal	5120 <printf>
        exit(1);
    484c:	4505                	li	a0,1
    ...
    485e:	98650513          	addi	a0,a0,-1658 # 71e0 <malloc+0x2008>
    4862:	0bf000ef          	jal	5120 <printf>
    exit(1);
    4866:	4505                	li	a0,1
    ...
    4878:	98c50513          	addi	a0,a0,-1652 # 7200 <malloc+0x2028>
    487c:	0a5000ef          	jal	5120 <printf>
    exit(1);
    4880:	4505                	li	a0,1
  ...
  while(1){
    ...
    48be:	98650513          	addi	a0,a0,-1658 # 7240 <malloc+0x2068>
    48c2:	05f000ef          	jal	5120 <printf>
      exit(1);
    48c6:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4910:	954b8b93          	addi	s7,s7,-1708 # 7260 <malloc+0x2088>
    int free0 = countfree();
    int free1 = 0;
    ...
    492a:	952d0d13          	addi	s10,s10,-1710 # 7278 <malloc+0x20a0>
          return 1;
        }
      }
    }
    ...
    4932:	96ac8c93          	addi	s9,s9,-1686 # 7298 <malloc+0x20c0>
    4936:	a819                	j	494c <drivetests+0x62>
        printf("usertests slow tests starting\n");
    4938:	856a                	mv	a0,s10
    493a:	7e6000ef          	jal	5120 <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    49ee:	8de58593          	addi	a1,a1,-1826 # 72c8 <malloc+0x20f0>
    49f2:	854a                	mv	a0,s2
    ...
    4a00:	8d458593          	addi	a1,a1,-1836 # 72d0 <malloc+0x20f8>
    4a04:	854a                	mv	a0,s2
    4a06:	090000ef          	jal	4a96 <strcmp>
    4a0a:	cd15                	beqz	a0,4a46 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    4a0c:	00003597          	auipc	a1,0x3
    4a10:	8cc58593          	addi	a1,a1,-1844 # 72d8 <malloc+0x2100>
    4a14:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    4a32:	8b250513          	addi	a0,a0,-1870 # 72e0 <malloc+0x2108>
    4a36:	6ea000ef          	jal	5120 <printf>
    exit(1);
    4a3a:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4a56:	8be50513          	addi	a0,a0,-1858 # 7310 <malloc+0x2138>
    4a5a:	6c6000ef          	jal	5120 <printf>
  exit(0);
    4a5e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4de4:	90080813          	addi	a6,a6,-1792 # 76e0 <digits>
    4de8:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4e64:	28048463          	beqz	s1,50ec <vprintf+0x296>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4eae:	22048763          	beqz	s1,50dc <vprintf+0x286>
    c0 = fmt[i] & 0xff;
    ...
    4ed0:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4ed4:	05878263          	beq	a5,s8,4f18 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4ed8:	05978c63          	beq	a5,s9,4f30 <vprintf+0xda>
    ...
    4ee0:	0ee78663          	beq	a5,a4,4fcc <vprintf+0x176>
    ...
    4ee8:	12e78863          	beq	a5,a4,5018 <vprintf+0x1c2>
    ...
    4ef0:	14e78d63          	beq	a5,a4,504a <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4ef4:	07300713          	li	a4,115
    4ef8:	18e78c63          	beq	a5,a4,5090 <vprintf+0x23a>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == 'c'){
    4efc:	06300713          	li	a4,99
    4f00:	1ce78163          	beq	a5,a4,50c2 <vprintf+0x26c>
        putc(fd, va_arg(ap, int));
      } else if(c0 == '%'){
    4f04:	02500713          	li	a4,37
    4f08:	04e79463          	bne	a5,a4,4f50 <vprintf+0xfa>
        putc(fd, '%');
    4f0c:	85ba                	mv	a1,a4
    4f0e:	855a                	mv	a0,s6
    4f10:	e93ff0ef          	jal	4da2 <putc>
    ...
    4f24:	855a                	mv	a0,s6
    4f26:	e9bff0ef          	jal	4dc0 <printint>
    4f2a:	8ba6                	mv	s7,s1
      state = 0;
    4f2c:	4981                	li	s3,0
    4f2e:	bf8d                	j	4ea0 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4f30:	06400793          	li	a5,100
    4f34:	02f68963          	beq	a3,a5,4f66 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f38:	06c00793          	li	a5,108
    4f3c:	04f68263          	beq	a3,a5,4f80 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4f40:	07500793          	li	a5,117
    4f44:	0af68063          	beq	a3,a5,4fe4 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4f48:	07800793          	li	a5,120
    4f4c:	0ef68263          	beq	a3,a5,5030 <vprintf+0x1da>
        putc(fd, '%');
    ...
    4f5a:	85a6                	mv	a1,s1
    4f5c:	855a                	mv	a0,s6
    4f5e:	e45ff0ef          	jal	4da2 <putc>
      state = 0;
    4f62:	4981                	li	s3,0
    4f64:	bf35                	j	4ea0 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4f72:	855a                	mv	a0,s6
    4f74:	e4dff0ef          	jal	4dc0 <printint>
        i += 1;
    ...
    4f7c:	4981                	li	s3,0
        i += 1;
    4f7e:	b70d                	j	4ea0 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f80:	06400793          	li	a5,100
    4f84:	02f60763          	beq	a2,a5,4fb2 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4f88:	07500793          	li	a5,117
    4f8c:	06f60963          	beq	a2,a5,4ffe <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4f90:	07800793          	li	a5,120
    4f94:	faf61ee3          	bne	a2,a5,4f50 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4fa4:	855a                	mv	a0,s6
    4fa6:	e1bff0ef          	jal	4dc0 <printint>
        i += 2;
    ...
    4fbe:	855a                	mv	a0,s6
    4fc0:	e01ff0ef          	jal	4dc0 <printint>
        i += 2;
    ...
    4fd8:	855a                	mv	a0,s6
    4fda:	de7ff0ef          	jal	4dc0 <printint>
    4fde:	8ba6                	mv	s7,s1
      state = 0;
    4fe0:	4981                	li	s3,0
    4fe2:	bd7d                	j	4ea0 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4ff0:	855a                	mv	a0,s6
    4ff2:	dcfff0ef          	jal	4dc0 <printint>
        i += 1;
    ...
    500a:	855a                	mv	a0,s6
    500c:	db5ff0ef          	jal	4dc0 <printint>
        i += 2;
    ...
    5024:	855a                	mv	a0,s6
    5026:	d9bff0ef          	jal	4dc0 <printint>
    502a:	8ba6                	mv	s7,s1
      state = 0;
    502c:	4981                	li	s3,0
    502e:	bd8d                	j	4ea0 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    503c:	855a                	mv	a0,s6
    503e:	d83ff0ef          	jal	4dc0 <printint>
        i += 1;
  ...
  putc(fd, '0');
    ...
    5058:	855a                	mv	a0,s6
    505a:	d49ff0ef          	jal	4da2 <putc>
  putc(fd, 'x');
    505e:	07800593          	li	a1,120
    5062:	855a                	mv	a0,s6
    5064:	d3fff0ef          	jal	4da2 <putc>
    5068:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    506a:	00002b97          	auipc	s7,0x2
    506e:	676b8b93          	addi	s7,s7,1654 # 76e0 <digits>
    5072:	03c9d793          	srli	a5,s3,0x3c
    5076:	97de                	add	a5,a5,s7
    5078:	0007c583          	lbu	a1,0(a5)
    507c:	855a                	mv	a0,s6
    507e:	d25ff0ef          	jal	4da2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5082:	0992                	slli	s3,s3,0x4
    5084:	34fd                	addiw	s1,s1,-1
    5086:	f4f5                	bnez	s1,5072 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5088:	8bea                	mv	s7,s10
      state = 0;
    508a:	4981                	li	s3,0
    508c:	6d02                	ld	s10,0(sp)
    508e:	bd09                	j	4ea0 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    5090:	008b8993          	addi	s3,s7,8
    5094:	000bb483          	ld	s1,0(s7)
    5098:	cc91                	beqz	s1,50b4 <vprintf+0x25e>
        for(; *s; s++)
    509a:	0004c583          	lbu	a1,0(s1)
    509e:	cd85                	beqz	a1,50d6 <vprintf+0x280>
          putc(fd, *s);
    50a0:	855a                	mv	a0,s6
    50a2:	d01ff0ef          	jal	4da2 <putc>
        for(; *s; s++)
    50a6:	0485                	addi	s1,s1,1
    50a8:	0004c583          	lbu	a1,0(s1)
    50ac:	f9f5                	bnez	a1,50a0 <vprintf+0x24a>
        if((s = va_arg(ap, char*)) == 0)
    50ae:	8bce                	mv	s7,s3
      state = 0;
    50b0:	4981                	li	s3,0
    50b2:	b3fd                	j	4ea0 <vprintf+0x4a>
          s = "(null)";
    50b4:	00002497          	auipc	s1,0x2
    50b8:	5ac48493          	addi	s1,s1,1452 # 7660 <malloc+0x2488>
        for(; *s; s++)
    50bc:	02800593          	li	a1,40
    50c0:	b7c5                	j	50a0 <vprintf+0x24a>
        putc(fd, va_arg(ap, int));
    50c2:	008b8493          	addi	s1,s7,8
    50c6:	000bc583          	lbu	a1,0(s7)
    50ca:	855a                	mv	a0,s6
    50cc:	cd7ff0ef          	jal	4da2 <putc>
    50d0:	8ba6                	mv	s7,s1
      state = 0;
    50d2:	4981                	li	s3,0
    50d4:	b3f1                	j	4ea0 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    50d6:	8bce                	mv	s7,s3
      state = 0;
    50d8:	4981                	li	s3,0
    50da:	b3d9                	j	4ea0 <vprintf+0x4a>
    50dc:	6906                	ld	s2,64(sp)
    50de:	79e2                	ld	s3,56(sp)
    50e0:	7a42                	ld	s4,48(sp)
    50e2:	7aa2                	ld	s5,40(sp)
    50e4:	7b02                	ld	s6,32(sp)
    50e6:	6be2                	ld	s7,24(sp)
    50e8:	6c42                	ld	s8,16(sp)
    50ea:	6ca2                	ld	s9,8(sp)
    }
  }
}
    ...
    50f2:	6125                	addi	sp,sp,96
    50f4:	8082                	ret

00000000000050f6 <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
    ...
    50fc:	1000                	addi	s0,sp,32
    50fe:	e010                	sd	a2,0(s0)
    5100:	e414                	sd	a3,8(s0)
    5102:	e818                	sd	a4,16(s0)
    5104:	ec1c                	sd	a5,24(s0)
    5106:	03043023          	sd	a6,32(s0)
    510a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    510e:	8622                	mv	a2,s0
    5110:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5114:	d43ff0ef          	jal	4e56 <vprintf>
  va_end(ap);
}
    5118:	60e2                	ld	ra,24(sp)
    511a:	6442                	ld	s0,16(sp)
    511c:	6161                	addi	sp,sp,80
    511e:	8082                	ret

0000000000005120 <printf>:

void
printf(const char *fmt, ...)
{
    5120:	711d                	addi	sp,sp,-96
    5122:	ec06                	sd	ra,24(sp)
    5124:	e822                	sd	s0,16(sp)
    5126:	1000                	addi	s0,sp,32
    5128:	e40c                	sd	a1,8(s0)
    512a:	e810                	sd	a2,16(s0)
    512c:	ec14                	sd	a3,24(s0)
    512e:	f018                	sd	a4,32(s0)
    5130:	f41c                	sd	a5,40(s0)
    5132:	03043823          	sd	a6,48(s0)
    5136:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    513a:	00840613          	addi	a2,s0,8
    513e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5142:	85aa                	mv	a1,a0
    5144:	4505                	li	a0,1
    5146:	d11ff0ef          	jal	4e56 <vprintf>
  va_end(ap);
}
    514a:	60e2                	ld	ra,24(sp)
    514c:	6442                	ld	s0,16(sp)
    514e:	6125                	addi	sp,sp,96
    5150:	8082                	ret

0000000000005152 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5152:	1141                	addi	sp,sp,-16
    5154:	e406                	sd	ra,8(sp)
    5156:	e022                	sd	s0,0(sp)
    5158:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    515a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    515e:	00004797          	auipc	a5,0x4
    5162:	2f27b783          	ld	a5,754(a5) # 9450 <freep>
    5166:	a02d                	j	5190 <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5168:	4618                	lw	a4,8(a2)
    516a:	9f2d                	addw	a4,a4,a1
    516c:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5170:	6398                	ld	a4,0(a5)
    5172:	6310                	ld	a2,0(a4)
    5174:	a83d                	j	51b2 <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5176:	ff852703          	lw	a4,-8(a0)
    517a:	9f31                	addw	a4,a4,a2
    517c:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    517e:	ff053683          	ld	a3,-16(a0)
    5182:	a091                	j	51c6 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5184:	6398                	ld	a4,0(a5)
    5186:	00e7e463          	bltu	a5,a4,518e <free+0x3c>
    518a:	00e6ea63          	bltu	a3,a4,519e <free+0x4c>
{
    518e:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5190:	fed7fae3          	bgeu	a5,a3,5184 <free+0x32>
    5194:	6398                	ld	a4,0(a5)
    5196:	00e6e463          	bltu	a3,a4,519e <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    519a:	fee7eae3          	bltu	a5,a4,518e <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    519e:	ff852583          	lw	a1,-8(a0)
    51a2:	6390                	ld	a2,0(a5)
    51a4:	02059813          	slli	a6,a1,0x20
    51a8:	01c85713          	srli	a4,a6,0x1c
    51ac:	9736                	add	a4,a4,a3
    51ae:	fae60de3          	beq	a2,a4,5168 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
    51b2:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    51b6:	4790                	lw	a2,8(a5)
    51b8:	02061593          	slli	a1,a2,0x20
    51bc:	01c5d713          	srli	a4,a1,0x1c
    51c0:	973e                	add	a4,a4,a5
    51c2:	fae68ae3          	beq	a3,a4,5176 <free+0x24>
    p->s.ptr = bp->s.ptr;
    51c6:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    51c8:	00004717          	auipc	a4,0x4
    51cc:	28f73423          	sd	a5,648(a4) # 9450 <freep>
}
    51d0:	60a2                	ld	ra,8(sp)
    51d2:	6402                	ld	s0,0(sp)
    51d4:	0141                	addi	sp,sp,16
    51d6:	8082                	ret

00000000000051d8 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    51e4:	02051993          	slli	s3,a0,0x20
    51e8:	0209d993          	srli	s3,s3,0x20
    51ec:	09bd                	addi	s3,s3,15
    51ee:	0049d993          	srli	s3,s3,0x4
    51f2:	2985                	addiw	s3,s3,1
    51f4:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    51f6:	00004517          	auipc	a0,0x4
    51fa:	25a53503          	ld	a0,602(a0) # 9450 <freep>
    51fe:	c905                	beqz	a0,522e <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5200:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5202:	4798                	lw	a4,8(a5)
    5204:	09377663          	bgeu	a4,s3,5290 <malloc+0xb8>
    5208:	f426                	sd	s1,40(sp)
    520a:	e852                	sd	s4,16(sp)
    520c:	e456                	sd	s5,8(sp)
    520e:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5210:	8a4e                	mv	s4,s3
    5212:	6705                	lui	a4,0x1
    5214:	00e9f363          	bgeu	s3,a4,521a <malloc+0x42>
    5218:	6a05                	lui	s4,0x1
    521a:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    521e:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5222:	00004497          	auipc	s1,0x4
    5226:	22e48493          	addi	s1,s1,558 # 9450 <freep>
  if(p == (char*)-1)
    522a:	5afd                	li	s5,-1
    522c:	a83d                	j	526a <malloc+0x92>
    522e:	f426                	sd	s1,40(sp)
    5230:	e852                	sd	s4,16(sp)
    5232:	e456                	sd	s5,8(sp)
    5234:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5236:	0000b797          	auipc	a5,0xb
    523a:	a4278793          	addi	a5,a5,-1470 # fc78 <base>
    523e:	00004717          	auipc	a4,0x4
    5242:	20f73923          	sd	a5,530(a4) # 9450 <freep>
    5246:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5248:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    524c:	b7d1                	j	5210 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    524e:	6398                	ld	a4,0(a5)
    5250:	e118                	sd	a4,0(a0)
    5252:	a899                	j	52a8 <malloc+0xd0>
  hp->s.size = nu;
    5254:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5258:	0541                	addi	a0,a0,16
    525a:	ef9ff0ef          	jal	5152 <free>
  return freep;
    525e:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5260:	c125                	beqz	a0,52c0 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5262:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5264:	4798                	lw	a4,8(a5)
    5266:	03277163          	bgeu	a4,s2,5288 <malloc+0xb0>
    if(p == freep)
    526a:	6098                	ld	a4,0(s1)
    526c:	853e                	mv	a0,a5
    526e:	fef71ae3          	bne	a4,a5,5262 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    5272:	8552                	mv	a0,s4
    5274:	b17ff0ef          	jal	4d8a <sbrk>
  if(p == (char*)-1)
    5278:	fd551ee3          	bne	a0,s5,5254 <malloc+0x7c>
        return 0;
    527c:	4501                	li	a0,0
    527e:	74a2                	ld	s1,40(sp)
    5280:	6a42                	ld	s4,16(sp)
    5282:	6aa2                	ld	s5,8(sp)
    5284:	6b02                	ld	s6,0(sp)
    5286:	a03d                	j	52b4 <malloc+0xdc>
    5288:	74a2                	ld	s1,40(sp)
    528a:	6a42                	ld	s4,16(sp)
    528c:	6aa2                	ld	s5,8(sp)
    528e:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5290:	fae90fe3          	beq	s2,a4,524e <malloc+0x76>
        p->s.size -= nunits;
    5294:	4137073b          	subw	a4,a4,s3
    5298:	c798                	sw	a4,8(a5)
        p += p->s.size;
    529a:	02071693          	slli	a3,a4,0x20
    529e:	01c6d713          	srli	a4,a3,0x1c
    52a2:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    52a4:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    52a8:	00004717          	auipc	a4,0x4
    52ac:	1aa73423          	sd	a0,424(a4) # 9450 <freep>
      return (void*)(p + 1);
    52b0:	01078513          	addi	a0,a5,16
  }
}
    52b4:	70e2                	ld	ra,56(sp)
    52b6:	7442                	ld	s0,48(sp)
    52b8:	7902                	ld	s2,32(sp)
    52ba:	69e2                	ld	s3,24(sp)
    52bc:	6121                	addi	sp,sp,64
    52be:	8082                	ret
    52c0:	74a2                	ld	s1,40(sp)
    52c2:	6a42                	ld	s4,16(sp)
    52c4:	6aa2                	ld	s5,8(sp)
    52c6:	6b02                	ld	s6,0(sp)
    52c8:	b7f5                	j	52b4 <malloc+0xdc>
